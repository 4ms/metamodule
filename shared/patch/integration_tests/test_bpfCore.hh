#include "patch.hh"
static const Patch test_bpfCore = { 
    .patch_name = "test_bpfCore",
    .modules_used = {
        "PANEL_8",
        "BANDPASSFILTER",
        "NOISE",
    ...
    .static_knobs = {{
        {.module_id = 1, .param_id = 0, .value = 0.607000f},
        {.module_id = 1, .param_id = 1, .value = 0.000000f},
        {.module_id = 1, .param_id = 2, .value = 1.000000f},
        {.module_id = 3, .param_id = 0, .value = 0.096000f},
    ...
    .mapped_knobs = {{
        ...
        {.module_id = 3, .param_id = 2, .panel_knob_id = 3},
    }},
    .num_mapped_knobs = 4,
