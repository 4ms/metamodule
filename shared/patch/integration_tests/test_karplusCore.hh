#include "patch.hh"
static const Patch test_karplusCore = { 
    ...
    .static_knobs = {{
        {.module_id = 1, .param_id = 0, .value = 0.126000f},
        {.module_id = 1, .param_id = 1, .value = 0.076500f},
        {.module_id = 1, .param_id = 2, .value = 0.019500f},
        {.module_id = 2, .param_id = 0, .value = 0.073500f},
        {.module_id = 2, .param_id = 1, .value = 0.493500f},
        {.module_id = 2, .param_id = 2, .value = 1.000000f},
        {.module_id = 3, .param_id = 0, .value = 0.607501f},
