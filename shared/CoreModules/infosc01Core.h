...
public:
	// Auto generated:
	// clang-format off
	static inline const int NumInJacks = 11; //2 are buttons, though
	static inline const int NumOutJacks = 1;
	static inline const int NumKnobs = 8;
	enum Knob {PitchKnob, TrackKnob, RangeKnob, FMKnob, AbsKnob, PhaseKnob, ModshapeKnob, WaveKnob};
	enum InJack {PitchInJack, RangeInJack, FMInJack, ModInJack, AbsInJack, LinInJack, PhaseInJack, PMInJack, ScanInJack, AddInJack, ResetInJack};
