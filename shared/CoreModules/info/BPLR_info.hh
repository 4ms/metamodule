...
struct BPLRInfo : ModuleInfoBase {
    static constexpr std::string_view slug{"BPLR"};
    static constexpr std::string_view description{"Bi-Polar"};
    static constexpr uint32_t width_hp = 4;
    static constexpr std::string_view svg_filename{"res/modules/BPLR-artwork.svg"};
