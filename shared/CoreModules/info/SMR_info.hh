...
struct SMRInfo : ModuleInfoBase {
    ...
    static inline const StaticString<LongNameChars> description{"Spectral Multiband Resonator"};
    ...
    static constexpr std::array<KnobDef, NumKnobs> Knobs{{
        ...
        },
        {
            ...
            .y_mm = px_to_mm<72>(43.03f),
            .short_name = "Freq Evens",
            .long_name = "Freq Evens",
            .default_val = 0.0f,
            .knob_style = KnobDef::Small,
        },
        {
    ...
    enum {
        ...
        InputLock_Odds_Gate = 2,
        InputLock_Evens_Gate = 3,
        InputLevel_Cv_1 = 4,
        InputLevel_Cv_2 = 5,
        InputLevel_Cv_3 = 6,
        InputLevel_Cv_4 = 7,
        ...
        InputLevel_Cv_6 = 9,
        InputRotate_Cv = 10,
        InputRotate_Down_Trig = 11,
        InputRotate_Up_Trig = 12,
        InputIn_Odds = 13,
        InputIn_Evens = 14,
        InputScale_Cv = 15,
        InputRes__Q__Cv = 16,
    ...
    static constexpr std::array<InJackDef, NumInJacks> InJacks{{
        ...
        {
            .id = InputLock_Odds_Gate,
            .x_mm = px_to_mm<72>(22.71f),
            .y_mm = px_to_mm<72>(122.19f),
            .short_name = "Lock Odds Gate",
            .long_name = "Lock Odds Gate",
            .unpatched_val = 0.f,
            .signal_type = InJackDef::Analog,
        },
        {
            .id = InputLock_Evens_Gate,
            .x_mm = px_to_mm<72>(350.89f),
            .y_mm = px_to_mm<72>(122.19f),
            .short_name = "Lock Evens Gate",
            .long_name = "Lock Evens Gate",
            .unpatched_val = 0.f,
            .signal_type = InJackDef::Analog,
        },
        {
        ...
        },
        {
            ...
            .short_name = "Rotate CV",
            .long_name = "Rotate CV",
            .unpatched_val = 0.f,
            .signal_type = InJackDef::Analog,
        },
        {
            .id = InputRotate_Down_Trig,
            .x_mm = px_to_mm<72>(116.35f),
            .y_mm = px_to_mm<72>(243.84f),
            .short_name = "Rotate Down Trig",
            .long_name = "Rotate Down Trig",
            .unpatched_val = 0.f,
            .signal_type = InJackDef::Analog,
        },
        {
            .id = InputRotate_Up_Trig,
            .x_mm = px_to_mm<72>(257.0f),
            .y_mm = px_to_mm<72>(244.85f),
            .short_name = "Rotate Up Trig",
            .long_name = "Rotate Up Trig",
            .unpatched_val = 0.f,
            .signal_type = InJackDef::Analog,
        },
        {
