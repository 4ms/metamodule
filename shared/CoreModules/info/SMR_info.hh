...
struct SMRInfo : ModuleInfoBase {
    ...
    static constexpr std::array<InJackDef, NumInJacks> InJacks{{
        {
            .id = InputFreq_Odds_Jack,
            .x_mm = px_to_mm<72>(22.71f),
            .y_mm = px_to_mm<72>(82.89f),
            .short_name = "Freq Odds Jack",
            .long_name = "Freq Odds Jack",
            .unpatched_val = 0.f,
            .signal_type = InJackDef::Analog,
        },
        {
            .id = InputFreq_Evens_Jack,
            .x_mm = px_to_mm<72>(350.89f),
            .y_mm = px_to_mm<72>(82.89f),
            .short_name = "Freq Evens Jack",
            .long_name = "Freq Evens Jack",
            .unpatched_val = 0.f,
            .signal_type = InJackDef::Analog,
        },
        {
            .id = InputLock_Odds_Jack,
            .x_mm = px_to_mm<72>(22.71f),
            .y_mm = px_to_mm<72>(122.19f),
            .short_name = "Lock Odds Jack",
            .long_name = "Lock Odds Jack",
            .unpatched_val = 0.f,
            .signal_type = InJackDef::Analog,
        },
        {
            .id = InputLock_Evens_Jack,
            .x_mm = px_to_mm<72>(350.89f),
            .y_mm = px_to_mm<72>(122.19f),
            .short_name = "Lock Evens Jack",
            .long_name = "Lock Evens Jack",
            .unpatched_val = 0.f,
            .signal_type = InJackDef::Analog,
        },
        {
        ...
        {
            .id = InputRotate_Trig_L,
            .x_mm = px_to_mm<72>(116.35f),
            .y_mm = px_to_mm<72>(243.84f),
            .short_name = "Rotate Trig L",
            .long_name = "Rotate Trig L",
            .unpatched_val = 0.f,
            .signal_type = InJackDef::Analog,
        },
        {
        ...
        {
            .id = InputRotate_Trig_R,
            .x_mm = px_to_mm<72>(257.0f),
            .y_mm = px_to_mm<72>(244.85f),
            .short_name = "Rotate Trig R",
            .long_name = "Rotate Trig R",
            .unpatched_val = 0.f,
            .signal_type = InJackDef::Analog,
        },
        {
        ...
        {
            .id = InputRes__Q__Jack,
            .x_mm = px_to_mm<72>(105.72f),
            .y_mm = px_to_mm<72>(283.22f),
            .short_name = "Res (Q) Jack",
            .long_name = "Res (Q) Jack",
            .unpatched_val = 0.f,
            .signal_type = InJackDef::Analog,
        },
        {
            ...
            .y_mm = px_to_mm<72>(283.22f),
            .short_name = "Morph Jack",
            .long_name = "Morph Jack",
            .unpatched_val = 0.f,
            .signal_type = InJackDef::Analog,
        },
        {
