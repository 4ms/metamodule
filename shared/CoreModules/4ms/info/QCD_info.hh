...
struct QCDInfo : ModuleInfoBase {
    ...
    static constexpr std::array<Element, 54> Elements{{
		...
		Davies1900hBlackKnob{{to_mm<72>(202.3), to_mm<72>(84.93), Center, "Div Mult 1", ""}, 0.0f},
		...
		Davies1900hBlackKnob{{to_mm<72>(202.3), to_mm<72>(154.05), Center, "Div Mult 2", ""}, 0.25f},
		...
		Davies1900hBlackKnob{{to_mm<72>(202.3), to_mm<72>(223.17), Center, "Div Mult 3", ""}, 0.875f},
		...
		Davies1900hBlackKnob{{to_mm<72>(202.3), to_mm<72>(292.29), Center, "Div Mult 4", ""}, 1.0f},
