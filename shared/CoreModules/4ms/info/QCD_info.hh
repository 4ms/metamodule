...
struct QCDInfo : ModuleInfoBase {
    ...
    static constexpr std::array<Element, 50> Elements{{
		Knob9mm{to_mm<72>(67.25), to_mm<72>(58.66), "Gate PW Att 1", ""},
		Davies1900hBlackKnob{to_mm<72>(108.76), to_mm<72>(60.04), "Gate PW 1", ""},
		Knob9mm{to_mm<72>(153.48), to_mm<72>(81.3), "Div Mult CV 1", ""},
		Davies1900hBlackKnob{to_mm<72>(202.43), to_mm<72>(85.05), "Div Mult 1", ""},
		Knob9mm{to_mm<72>(67.25), to_mm<72>(134.26), "Gate PW Att 2", ""},
		Davies1900hBlackKnob{to_mm<72>(108.76), to_mm<72>(135.64), "Gate PW 2", ""},
		Knob9mm{to_mm<72>(153.48), to_mm<72>(150.39), "Div Mult CV 2", ""},
		Davies1900hBlackKnob{to_mm<72>(202.43), to_mm<72>(154.17), "Div Mult 2", ""},
		Knob9mm{to_mm<72>(67.25), to_mm<72>(209.86), "Gate PW Att 3", ""},
		Davies1900hBlackKnob{to_mm<72>(108.76), to_mm<72>(211.24), "Gate PW 3", ""},
		Knob9mm{to_mm<72>(153.48), to_mm<72>(220.06), "Div Mult CV 3", ""},
		Davies1900hBlackKnob{to_mm<72>(202.43), to_mm<72>(223.29), "Div Mult 3", ""},
		Knob9mm{to_mm<72>(67.25), to_mm<72>(285.46), "Gate PW Att 4", ""},
		Davies1900hBlackKnob{to_mm<72>(108.76), to_mm<72>(286.84), "Gate PW 4", ""},
		Knob9mm{to_mm<72>(153.48), to_mm<72>(288.47), "Div Mult CV 4", ""},
		Davies1900hBlackKnob{to_mm<72>(202.43), to_mm<72>(292.41), "Div Mult 4", ""},
