...
struct SequantInfo : ModuleInfoBase {
    ...
    static constexpr std::array<Element, 44> Elements{{
		...
		Knob9mm{to_mm<72>(178.96), to_mm<72>(46.59), "Slew", ""},
		Knob9mm{to_mm<72>(22.96), to_mm<72>(99.16), "Step 1-1", ""},
		Knob9mm{to_mm<72>(51.3), to_mm<72>(99.16), "Step 2-1", ""},
		Knob9mm{to_mm<72>(79.65), to_mm<72>(99.16), "Step 3-1", ""},
		Knob9mm{to_mm<72>(108.0), to_mm<72>(99.16), "Step 4-1", ""},
		Knob9mm{to_mm<72>(136.44), to_mm<72>(99.16), "Step 5-1", ""},
		Knob9mm{to_mm<72>(164.79), to_mm<72>(99.16), "Step 6-1", ""},
		Knob9mm{to_mm<72>(193.13), to_mm<72>(99.16), "Step 7-1", ""},
		Knob9mm{to_mm<72>(221.48), to_mm<72>(99.16), "Step 8-1", ""},
		Knob9mm{to_mm<72>(22.96), to_mm<72>(137.36), "Step 1-2", ""},
		Knob9mm{to_mm<72>(51.3), to_mm<72>(137.36), "Step 2-2", ""},
		Knob9mm{to_mm<72>(79.65), to_mm<72>(137.36), "Step 3-2", ""},
		Knob9mm{to_mm<72>(108.0), to_mm<72>(137.36), "Step 4-2", ""},
		Knob9mm{to_mm<72>(136.44), to_mm<72>(137.36), "Step 5-2", ""},
		Knob9mm{to_mm<72>(164.79), to_mm<72>(137.36), "Step 6-2", ""},
		Knob9mm{to_mm<72>(193.13), to_mm<72>(137.36), "Step 7-2", ""},
		Knob9mm{to_mm<72>(221.48), to_mm<72>(137.36), "Step 8-2", ""},
		Knob9mm{to_mm<72>(31.99), to_mm<72>(170.27), "Scale", ""},
		Knob9mm{to_mm<72>(212.77), to_mm<72>(170.27), "Chance", ""},
		Knob9mm{to_mm<72>(31.99), to_mm<72>(211.46), "Root", ""},
		Knob9mm{to_mm<72>(212.77), to_mm<72>(211.46), "Repeat", ""},
