...
struct DEVInfo : ModuleInfoBase {
    ...
    static constexpr std::array<Element, 44> Elements{{
		Slider25mmVertLED{to_mm<72>(22.415), to_mm<72>(108.25), "Rise A Slider", ""},
		Slider25mmVertLED{to_mm<72>(56.265), to_mm<72>(108.25), "Fall A Slider", ""},
		Slider25mmVertLED{to_mm<72>(174.115), to_mm<72>(108.25), "Rise B Slider", ""},
		Slider25mmVertLED{to_mm<72>(207.965), to_mm<72>(108.25), "Fall B Slider", ""},
		Knob9mm{to_mm<72>(93.13), to_mm<72>(95.86), "Level A", ""},
		Knob9mm{to_mm<72>(137.25), to_mm<72>(95.86), "Level B", ""},
		Knob9mm{to_mm<72>(93.13), to_mm<72>(138.65), "Offset A", ""},
		Knob9mm{to_mm<72>(137.25), to_mm<72>(138.65), "Offset B", ""},
		Knob9mm{to_mm<72>(23.5), to_mm<72>(184.03), "Rise A", ""},
		Knob9mm{to_mm<72>(94.11), to_mm<72>(183.67), "Fall A", ""},
		Knob9mm{to_mm<72>(136.27), to_mm<72>(184.03), "Rise B", ""},
		Knob9mm{to_mm<72>(206.87), to_mm<72>(184.03), "Fall B", ""},
