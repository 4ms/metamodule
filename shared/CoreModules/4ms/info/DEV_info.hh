...
struct DEVInfo : ModuleInfoBase {
    ...
    static constexpr std::array<Element, 44> Elements{{
		...
		RedBlueLight{to_mm<72>(45.84), to_mm<72>(176.26), Center, "Rise LED A", ""},
		RedBlueLight{to_mm<72>(70.54), to_mm<72>(176.26), Center, "Fall LED A", ""},
		RedBlueLight{to_mm<72>(159.84), to_mm<72>(176.26), Center, "Rise LED B", ""},
		RedBlueLight{to_mm<72>(184.53), to_mm<72>(176.26), Center, "Fall LED B", ""},
		RedBlueLight{to_mm<72>(99.58), to_mm<72>(260.79), Center, "EOR LED", ""},
		RedBlueLight{to_mm<72>(130.68), to_mm<72>(261.07), Center, "EOF LED", ""},
		RedBlueLight{to_mm<72>(65.92), to_mm<72>(327.45), Center, "Env A LED", ""},
		RedBlueLight{to_mm<72>(164.39), to_mm<72>(327.52), Center, "Env B LED", ""},
