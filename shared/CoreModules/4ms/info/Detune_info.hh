...
struct DetuneInfo : ModuleInfoBase {
    ...
    static constexpr std::array<Element, 8> Elements{{
		Davies1900hBlackKnob{to_mm<72>(31.96), to_mm<72>(57.97), "W Speed", ""},
		Davies1900hBlackKnob{to_mm<72>(83.49), to_mm<72>(57.97), "F Speed", ""},
		Davies1900hBlackKnob{to_mm<72>(31.96), to_mm<72>(119.21), "W Depth", ""},
		Davies1900hBlackKnob{to_mm<72>(83.49), to_mm<72>(119.21), "F Depth", ""},
