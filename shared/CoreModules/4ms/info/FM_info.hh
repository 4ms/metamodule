...
struct FMInfo : ModuleInfoBase {
    ...
    static constexpr std::array<Element, 14> Elements{{
		Knob9mm{{to_mm<72>(31.83), to_mm<72>(40.21), Center, "Pitch", ""}, 0.0f},
		Knob9mm{{to_mm<72>(83.37), to_mm<72>(40.21), Center, "Mix", ""}, 0.0f},
		Knob9mm{{to_mm<72>(31.83), to_mm<72>(83.35), Center, "Index", ""}, 0.0f},
		Knob9mm{{to_mm<72>(83.37), to_mm<72>(83.35), Center, "Index CV", ""}, 0.0f},
		Knob9mm{{to_mm<72>(31.83), to_mm<72>(126.49), Center, "Ratio C", ""}, 0.0f},
		Knob9mm{{to_mm<72>(83.37), to_mm<72>(126.49), Center, "Ratio F", ""}, 0.0f},
		Knob9mm{{to_mm<72>(31.83), to_mm<72>(169.63), Center, "Shape", ""}, 0.0f},
		Knob9mm{{to_mm<72>(83.37), to_mm<72>(169.63), Center, "Shape CV", ""}, 0.0f},
