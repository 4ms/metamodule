...
struct DjembeInfo : ModuleInfoBase {
    ...
    static constexpr std::array<Element, 10> Elements{{
		Davies1900hBlackKnob{to_mm<72>(31.96), to_mm<72>(57.97), "Pitch", ""},
		Davies1900hBlackKnob{to_mm<72>(83.49), to_mm<72>(57.97), "Sharpness", ""},
		Davies1900hBlackKnob{to_mm<72>(31.96), to_mm<72>(119.21), "Hit", ""},
		Davies1900hBlackKnob{to_mm<72>(83.49), to_mm<72>(119.21), "Strike Amt", ""},
