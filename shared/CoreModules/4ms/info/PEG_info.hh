...
struct PEGInfo : ModuleInfoBase {
    ...
    static constexpr std::array<Element, 52> Elements{{
		...
		WhiteMomentary7mm{{to_mm<72>(68.06), to_mm<72>(45.56), Center, "Ping Red", ""}},
		OrangeButton{{to_mm<72>(120.9), to_mm<72>(41.96), Center, "Cycle Red", ""}},
		OrangeButton{{to_mm<72>(21.56), to_mm<72>(213.99), Center, "Bi-polar Red", ""}},
		WhiteMomentary7mm{{to_mm<72>(220.56), to_mm<72>(45.56), Center, "Ping Blue", ""}},
		OrangeButton{{to_mm<72>(167.48), to_mm<72>(41.9), Center, "Cycle Blue", ""}},
