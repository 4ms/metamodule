...
struct PEGInfo : ModuleInfoBase {
    ...
    static constexpr std::array<Element, 52> Elements{{
		Davies1900hBlackKnob{{to_mm<72>(34.2), to_mm<72>(106.06), Center, "Ping Div Mult Red", ""}},
		Davies1900hBlackKnob{{to_mm<72>(34.16), to_mm<72>(170.68), Center, "Scale Red", ""}},
		Davies1900hBlackKnob{{to_mm<72>(95.87), to_mm<72>(151.47), Center, "Skew Red", ""}},
		Davies1900hBlackKnob{{to_mm<72>(106.67), to_mm<72>(215.41), Center, "Curve Red", ""}},
		Davies1900hBlackKnob{{to_mm<72>(254.32), to_mm<72>(106.02), Center, "Ping Div Mult Blue", ""}},
		Davies1900hBlackKnob{{to_mm<72>(254.75), to_mm<72>(170.82), Center, "Scale Blue", ""}},
		Davies1900hBlackKnob{{to_mm<72>(192.91), to_mm<72>(151.47), Center, "Skew Blue", ""}},
		Davies1900hBlackKnob{{to_mm<72>(182.51), to_mm<72>(215.41), Center, "Curve Blue", ""}},
		...
		RedGreenBlueLight{{to_mm<72>(47.9), to_mm<72>(213.99), Center, "EnvRedLight", ""}},
		RedGreenBlueLight{{to_mm<72>(239.76), to_mm<72>(213.99), Center, "EnvBlueLight", ""}},
		RedGreenBlueLight{{to_mm<72>(73.01), to_mm<72>(258.36), Center, "EORRedLight", ""}},
		RedLight{{to_mm<72>(111.11), to_mm<72>(258.36), Center, "EOFRedLight", ""}},
		BlueLight{{to_mm<72>(177.5), to_mm<72>(258.36), Center, "EOFBlue", ""}},
		RedGreenBlueLight{{to_mm<72>(215.46), to_mm<72>(258.36), Center, "HalfRiseBlue", ""}},
