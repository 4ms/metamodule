...
struct STSInfo : ModuleInfoBase {
    ...
    static constexpr std::array<Element, 41> Elements{{
		...
		MomentaryButtonWhiteLight{{to_mm<72>(81.91), to_mm<72>(49.62), Center, "Play L", ""}},
		MomentaryButtonWhiteLight{{to_mm<72>(122.85), to_mm<72>(41.6), Center, "Bank L", ""}},
		MomentaryButtonWhiteLight{{to_mm<72>(164.37), to_mm<72>(41.88), Center, "Bank R", ""}},
		MomentaryButtonWhiteLight{{to_mm<72>(205.55), to_mm<72>(49.77), Center, "Play R", ""}},
		MomentaryButtonWhiteLight{{to_mm<72>(143.63), to_mm<72>(69.21), Center, "Edit Sample", ""}},
		MomentaryButtonWhiteLight{{to_mm<72>(127.63), to_mm<72>(139.65), Center, "REC", ""}},
		MomentaryButtonWhiteLight{{to_mm<72>(159.13), to_mm<72>(139.65), Center, "Bank", ""}},
		MomentaryButtonWhiteLight{{to_mm<72>(21.08), to_mm<72>(179.74), Center, "Reverse L", ""}},
		MomentaryButtonWhiteLight{{to_mm<72>(266.32), to_mm<72>(179.74), Center, "Reverse R", ""}},
}};
