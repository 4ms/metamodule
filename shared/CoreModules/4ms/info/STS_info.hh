...
struct STSInfo : ModuleInfoBase {
    ...
    static constexpr std::array<Element, 41> Elements{{
		Davies1900hBlackKnob{to_mm<72>(37.52), to_mm<72>(54.34), "Pitch L", ""},
		Davies1900hBlackKnob{to_mm<72>(249.91), to_mm<72>(54.27), "Pitch R", ""},
		Davies1900hBlackKnob{to_mm<72>(95.87), to_mm<72>(90.17), "Sample L", ""},
		Davies1900hBlackKnob{to_mm<72>(191.25), to_mm<72>(90.02), "Sample R", ""},
		Davies1900hBlackKnob{to_mm<72>(37.24), to_mm<72>(123.0), "Start Pos. L", ""},
		Davies1900hBlackKnob{to_mm<72>(249.6), to_mm<72>(122.95), "Start Pos. R", ""},
		Davies1900hBlackKnob{to_mm<72>(69.36), to_mm<72>(189.23), "Length L", ""},
		Davies1900hBlackKnob{to_mm<72>(143.45), to_mm<72>(183.69), "Sample", ""},
		Davies1900hBlackKnob{to_mm<72>(218.16), to_mm<72>(189.23), "Length R", ""},
