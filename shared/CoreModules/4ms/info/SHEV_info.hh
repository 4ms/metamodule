...
struct SHEVInfo : ModuleInfoBase {
    ...
    static constexpr std::array<Element, 55> Elements{{
		Slider25mmVertLED{to_mm<72>(94.665), to_mm<72>(104.78), "Rise A Slider", ""},
		Slider25mmVertLED{to_mm<72>(127.065), to_mm<72>(104.78), "Fall A Slider", ""},
		Slider25mmVertLED{to_mm<72>(159.945), to_mm<72>(104.78), "Rise B Slider", ""},
		Slider25mmVertLED{to_mm<72>(192.345), to_mm<72>(104.78), "Fall B Slider", ""},
		Slider25mmHorizLED{to_mm<72>(93.36), to_mm<72>(168.515), "Shape A Slider", ""},
		Slider25mmHorizLED{to_mm<72>(193.65), to_mm<72>(168.515), "Shape B Slider", ""},
		Knob9mm{to_mm<72>(23.59), to_mm<72>(86.1), "Level A", ""},
		Knob9mm{to_mm<72>(263.62), to_mm<72>(86.05), "Level B", ""},
		Knob9mm{to_mm<72>(23.67), to_mm<72>(132.68), "Offset A", ""},
		Knob9mm{to_mm<72>(263.42), to_mm<72>(132.63), "Offset B", ""},
		Knob9mm{to_mm<72>(23.59), to_mm<72>(179.21), "Shape A", ""},
		Knob9mm{to_mm<72>(263.45), to_mm<72>(179.21), "Shape B", ""},
		Knob9mm{to_mm<72>(68.74), to_mm<72>(206.72), "Rise A", ""},
		Knob9mm{to_mm<72>(117.86), to_mm<72>(206.72), "Fall A", ""},
		Knob9mm{to_mm<72>(169.15), to_mm<72>(206.72), "Rise B", ""},
		Knob9mm{to_mm<72>(218.26), to_mm<72>(206.72), "Fall B", ""},
