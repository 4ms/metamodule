...
struct Seq4Info : ModuleInfoBase {
    ...
    static constexpr std::array<Element, 6> Elements{{
		Knob9mm{to_mm<72>(28.93), to_mm<72>(46.53), "1", ""},
		Knob9mm{to_mm<72>(28.93), to_mm<72>(94.22), "2", ""},
		Knob9mm{to_mm<72>(28.93), to_mm<72>(142.91), "3", ""},
		Knob9mm{to_mm<72>(28.93), to_mm<72>(191.1), "4", ""},
