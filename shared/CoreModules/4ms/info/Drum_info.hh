...
struct DrumInfo : ModuleInfoBase {
    ...
    static constexpr std::array<Element, 21> Elements{{
		Davies1900hBlackKnob{{to_mm<72>(43.5), to_mm<72>(45.83), Center, "Pitch", ""}},
		Davies1900hBlackKnob{{to_mm<72>(108.0), to_mm<72>(45.83), Center, "Pitch Env", ""}},
		Davies1900hBlackKnob{{to_mm<72>(172.46), to_mm<72>(45.83), Center, "Pitch Amt", ""}},
		Davies1900hBlackKnob{{to_mm<72>(43.5), to_mm<72>(104.39), Center, "Ratio", ""}},
		Davies1900hBlackKnob{{to_mm<72>(108.0), to_mm<72>(104.39), Center, "FM Env", ""}},
		Davies1900hBlackKnob{{to_mm<72>(172.46), to_mm<72>(104.39), Center, "FM Amt", ""}},
		Davies1900hBlackKnob{{to_mm<72>(43.5), to_mm<72>(163.07), Center, "Tone Env", ""}},
		Davies1900hBlackKnob{{to_mm<72>(108.0), to_mm<72>(163.07), Center, "Noise Env", ""}},
		Davies1900hBlackKnob{{to_mm<72>(172.46), to_mm<72>(163.07), Center, "Noise Blend", ""}},
