...
struct ENVVCAInfo : ModuleInfoBase {
	...
	static constexpr std::array<Element, 19> Elements{{
		...
		RedBlueLight{to_mm<72>(45.11), to_mm<72>(174.84), "Rise Light", ""},
		RedBlueLight{to_mm<72>(69.34), to_mm<72>(174.84), "Fall Light", ""},
		OrangeLight{to_mm<72>(106.41), to_mm<72>(256.6), "EOR Light", ""},
