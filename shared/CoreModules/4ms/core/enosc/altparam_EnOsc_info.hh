...
struct EnOscInfo : ModuleInfoBase {
	...
	static constexpr std::array<Element, 27> Elements{{
		Davies1900hBlackKnob{to_mm<72>(54.1), to_mm<72>(78.08), "Scale", ""},
		Davies1900hBlackKnob{to_mm<72>(115.27), to_mm<72>(61.62), "Spread", ""},
		Davies1900hBlackKnob{to_mm<72>(176.96), to_mm<72>(78.07), "Pitch", ""},
		Davies1900hBlackKnob{to_mm<72>(32.72), to_mm<72>(144.14), "Balance", ""},
		DaviesLargeKnob{to_mm<72>(115.56), to_mm<72>(140.93), "Root", ""},
		Davies1900hBlackKnob{to_mm<72>(198.23), to_mm<72>(144.14), "Cross FM", ""},
		Davies1900hBlackKnob{to_mm<72>(61.77), to_mm<72>(208.21), "Twist", ""},
		Knob9mm{to_mm<72>(115.49), to_mm<72>(207.86), "Detune", ""},
		Davies1900hBlackKnob{to_mm<72>(168.87), to_mm<72>(208.21), "Warp", ""},
