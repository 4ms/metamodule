...
struct VCVModuleParamCreator {
	...
	void count_element(InJackElement element) { num_inputs++; };
	void count_element(OutJackElement element) { num_outputs++; };
	void count_element(KnobElement element) { num_params++; };
	void count_element(LightElement element) { num_lights++; };
	...
	void count_element(Toggle2pos element) { num_params++; };
	void count_element(Toggle3pos element) { num_params++; };
