...
struct MultilfoModule : CommModule {
	...
	enum ParamIds { RATE_PARAM, PHASE_PARAM, PW_PARAM, NUM_PARAMS };
	enum InputIds { FM_INPUT, PHASE_INPUT, PW_INPUT, RESET_INPUT, NUM_INPUTS };
	enum OutputIds { SIN_OUTPUT, SAW_OUTPUT, ISAW_OUTPUT, PULSE_OUTPUT, NUM_OUTPUTS };
