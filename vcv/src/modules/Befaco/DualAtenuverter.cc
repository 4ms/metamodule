...
struct DualAtenuverterWidget : ModuleWidget {
	DualAtenuverterWidget(DualAtenuverter *module) {
		...
		addInput(createInput<BefacoInputPort>(Vec(7, 152), module, IN1_INPUT));
		addOutput(createOutput<BefacoOutputPort>(Vec(43, 152), module, OUT1_OUTPUT));

		addInput(createInput<BefacoInputPort>(Vec(7, 319), module, IN2_INPUT));
		addOutput(createOutput<BefacoOutputPort>(Vec(43, 319), module, OUT2_OUTPUT));
