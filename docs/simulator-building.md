...
`make config-sim` logs at the DEBUG level to the console. To change this, use
the second command and change `-DLOG_LEVEL=...` (levels: NONE, ERROR, WARN,
INFO, DEBUG, TRACE, DUMP).
