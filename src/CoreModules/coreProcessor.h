...
public:
	...
	virtual void mark_input_unpatched(const int input_id) = 0;
	virtual void mark_input_patched(const int input_id) = 0;

	virtual void mark_all_outputs_unpatched() = 0;
	virtual void mark_output_unpatched(const int output_id) = 0;
	virtual void mark_output_patched(const int output_id) = 0;
