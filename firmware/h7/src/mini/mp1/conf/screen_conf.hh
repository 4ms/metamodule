...
struct MMScreenConf : mdrivlib::DefaultSpiScreenConf {
	...
	struct DMAConf : mdrivlib::DefaultDMAConf {
		...
		static constexpr auto IRQn = DMA2_Stream3_IRQn;
		static constexpr auto pri = 7;
		static constexpr auto subpri = 3;
	...
	static constexpr PinNoInit ResetPin{GPIO::E, 15}; //NOT REAL!
