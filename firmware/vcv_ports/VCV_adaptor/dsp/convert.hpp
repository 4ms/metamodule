...
/** Integer to float */
template<>
inline float convert(int8_t x) {
	return x / 128.f;
}
template<>
inline float convert(int16_t x) {
	return x / 32768.f;
}
template<>
inline float convert(Int24 x) {
	return x / 8388608.f;
}
template<>
inline float convert(int32_t x) {
	return x / 2147483648.f;
}
template<>
inline float convert(int64_t x) {
	return x / 9223372036854775808.f;
}

/** Float to integer */
template<>
inline int8_t convert(float x) {
	return std::min(std::llround(x * 128.f), 127LL);
}
template<>
inline int16_t convert(float x) {
	return std::min(std::llround(x * 32768.f), 32767LL);
}
template<>
inline Int24 convert(float x) {
...
template<>
inline int64_t convert(float x) {
