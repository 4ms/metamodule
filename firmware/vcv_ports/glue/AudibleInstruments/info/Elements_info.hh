...
struct ElementsInfo : ModuleInfoBase {
	...
	static constexpr std::array<Element, 48> Elements{{
		WhiteMediumKnob{{to_mm<72>(47.58), to_mm<72>(60.35), Center, "Contour", ""}, 1.0f},
		WhiteMediumKnob{{to_mm<72>(114.99), to_mm<72>(60.35), Center, "Bow", ""}, 0.0f},
		RedMediumKnob{{to_mm<72>(182.51), to_mm<72>(60.35), Center, "Blow", ""}, 0.0f},
		...
		WhiteMediumKnob{{to_mm<72>(452.59), to_mm<72>(214.27), Center, "Space", ""}, 0.0f},
		Trimpot{{to_mm<72>(108.81), to_mm<72>(270.97), Center, "Bow Timbre Atten", ""}, 0.5f},
		Trimpot{{to_mm<72>(145.66), to_mm<72>(270.97), Center, "Flow Atten", ""}, 0.5f},
		Trimpot{{to_mm<72>(182.51), to_mm<72>(270.97), Center, "Blow Timbre Atten", ""}, 0.5f},
		Trimpot{{to_mm<72>(219.36), to_mm<72>(270.97), Center, "Mallet Atten", ""}, 0.5f},
		Trimpot{{to_mm<72>(256.21), to_mm<72>(270.97), Center, "Strike Timbre Atten", ""}, 0.5f},
		Trimpot{{to_mm<72>(311.37), to_mm<72>(270.97), Center, "Damping Atten", ""}, 0.5f},
		Trimpot{{to_mm<72>(348.22), to_mm<72>(270.97), Center, "Geometry Atten", ""}, 0.5f},
		Trimpot{{to_mm<72>(385.07), to_mm<72>(270.97), Center, "Position Atten", ""}, 0.5f},
		Trimpot{{to_mm<72>(421.92), to_mm<72>(270.97), Center, "Brightness Atten", ""}, 0.5f},
		Trimpot{{to_mm<72>(458.77), to_mm<72>(270.97), Center, "Space Atten", ""}, 0.5f},
