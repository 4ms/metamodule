...
struct StreamsInfo : ModuleInfoBase {
    ...
    static constexpr std::array<Element, 27> Elements{{
		WhiteMediumKnob{{to_mm<72>(31.37), to_mm<72>(59.68), Center, "Ch1 Shape", ""}, 0.5f},
		WhiteMediumKnob{{to_mm<72>(31.37), to_mm<72>(126.3), Center, "Ch1 Mod", ""}, 0.5f},
		RedMediumKnob{{to_mm<72>(31.37), to_mm<72>(192.88), Center, "Ch1 Level Mod", ""}, 0.5f},
		Trimpot{{to_mm<72>(86.24), to_mm<72>(172.19), Center, "Ch1 Response", ""}, 0.0f},
		WhiteMediumKnob{{to_mm<72>(141.12), to_mm<72>(59.68), Center, "Ch2 Shape", ""}, 0.5f},
		WhiteMediumKnob{{to_mm<72>(141.12), to_mm<72>(126.3), Center, "Ch2 Mod", ""}, 0.5f},
		BlueMediumKnob{{to_mm<72>(141.12), to_mm<72>(192.88), Center, "Ch2 Level Mod", ""}, 0.5f},
		Trimpot{{to_mm<72>(86.24), to_mm<72>(213.58), Center, "Ch2 Response", ""}, 0.0f},
		MediumButton{{to_mm<72>(70.06), to_mm<72>(42.59), Center, "Ch1 Function", ""}},
		MediumButton{{to_mm<72>(102.43), to_mm<72>(42.59), Center, "Ch2 Function", ""}},
		MediumButton{{to_mm<72>(86.24), to_mm<72>(132.59), Center, "Meter", ""}},
