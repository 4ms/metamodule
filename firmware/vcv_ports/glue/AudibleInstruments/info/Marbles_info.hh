...
struct MarblesInfo : ModuleInfoBase {
	...
	static constexpr std::array<Element, 44> Elements{{
		...
		WhiteMediumKnob{{to_mm<72>(129.41), to_mm<72>(63.52), Center, "DejaVu", ""}, 0, 1, 0.5f},
		WhiteLargeKnob{{to_mm<72>(83.35), to_mm<72>(100.37), Center, "Clock Rate", ""}, -1, 1, 0.f},
		WhiteLargeKnob{{to_mm<72>(175.48), to_mm<72>(100.37), Center, "Spread", ""}, 0, 1, 0.5f},
		Toggle3pos{{to_mm<72>(19.57), to_mm<72>(96.045), Center, "T Mode Switch", ""}, {"1", "2", "3"}, Toggle3pos::State_t::UP},
		Toggle3pos{{to_mm<72>(239.26), to_mm<72>(96.045), Center, "X Mode Switch", ""}, {"1", "2", "3"}, Toggle3pos::State_t::UP},
		WhiteMediumKnob{{to_mm<72>(129.41), to_mm<72>(145.44), Center, "Length", ""}, 0, 1, 0.f},
		WhiteMediumKnob{{to_mm<72>(26.94), to_mm<72>(165.99), Center, "T Bias", ""}, 0, 1, 0.5f},
		WhiteMediumKnob{{to_mm<72>(231.89), to_mm<72>(165.99), Center, "X Bias", ""}, 0, 1, 0.5f},
		Toggle3pos{{to_mm<72>(75.41), to_mm<72>(158.675), Center, "Clock Range Switch", ""}, {"x4", "x1", "/4"}, Toggle3pos::State_t::CENTER},
		Toggle3pos{{to_mm<72>(183.42), to_mm<72>(158.675), Center, "Output Range Switch", ""}, {"+/-5V", "+5V", "+2V"}, Toggle3pos::State_t::CENTER},
		SmallButton{{to_mm<72>(129.41), to_mm<72>(191.22), Center, "External", ""}},
		WhiteMediumKnob{{to_mm<72>(89.3), to_mm<72>(209.36), Center, "Jitter", ""}, 0, 1, 0.f},
		WhiteMediumKnob{{to_mm<72>(169.52), to_mm<72>(209.36), Center, "Steps", ""}, 0, 1, 0.5f},
