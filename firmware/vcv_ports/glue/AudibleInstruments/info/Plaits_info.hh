...
struct PlaitsInfo : ModuleInfoBase {
    ...
    static constexpr std::array<Element, 29> Elements{{
		...
		WhiteLargeKnob{{to_mm<72>(34.73), to_mm<72>(82.74), Center, "Frequency", ""}, -4.0, 4.0, 0.0, "", " semitones", 0.f, 12.f},
		WhiteLargeKnob{{to_mm<72>(137.28), to_mm<72>(82.74), Center, "Harmonics", ""}, 0.0, 1.0, 0.5, "", "%", 0.f, 100.f},
		WhiteMediumKnob{{to_mm<72>(31.16), to_mm<72>(160.13), Center, "Timbre", ""}, 0.0, 1.0, 0.5, "", "%", 0.f, 100.f},
		WhiteMediumKnob{{to_mm<72>(140.79), to_mm<72>(160.13), Center, "Morph", ""}, 0.0, 1.0, 0.5, "", "%", 0.f, 100.f},
		Trimpot{{to_mm<72>(31.14), to_mm<72>(228.45), Center, "Timbre Atten", ""}, -1.f, 1.f, 0.f},
		Trimpot{{to_mm<72>(85.96), to_mm<72>(228.45), Center, "FM Atten", ""}, -1, 1, 0},
		Trimpot{{to_mm<72>(140.77), to_mm<72>(228.45), Center, "Morph Atten", ""}, -1, 1, 0},
