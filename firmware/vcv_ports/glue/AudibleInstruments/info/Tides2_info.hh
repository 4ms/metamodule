...
struct Tides2Info : ModuleInfoBase {
    ...
    static constexpr std::array<Element, 31> Elements{{
		...
		Trimpot{{to_mm<72>(26.6), to_mm<72>(228.63), Center, "Slope Atten", ""}, 0.0f},
		Trimpot{{to_mm<72>(63.59), to_mm<72>(228.63), Center, "Frequency Atten", ""}, 0.0f},
		Trimpot{{to_mm<72>(100.58), to_mm<72>(228.63), Center, "Smoothness Atten", ""}, 0.0f},
		Trimpot{{to_mm<72>(137.57), to_mm<72>(228.63), Center, "Shape Atten", ""}, 0.0f},
		Trimpot{{to_mm<72>(174.57), to_mm<72>(228.63), Center, "Shift Level Atten", ""}, 0.0f},
