...
struct RingsInfo : ModuleInfoBase {
    ...
    static constexpr std::array<Element, 24> Elements{{
		...
		WhiteLargeKnob{{to_mm<72>(53.65), to_mm<72>(94.75), Center, "Frequency", ""}, 0, 60, 30},
		WhiteLargeKnob{{to_mm<72>(147.21), to_mm<72>(94.75), Center, "Structure", ""}, },
		WhiteMediumKnob{{to_mm<72>(32.92), to_mm<72>(171.86), Center, "Brightness", ""}, 0, 1, 0.5f},
		WhiteMediumKnob{{to_mm<72>(100.4), to_mm<72>(171.86), Center, "Damping", ""}, 0, 1, 0.5f},
		WhiteMediumKnob{{to_mm<72>(167.89), to_mm<72>(171.86), Center, "Position", ""}, 0, 1, 0.5f},
		Trimpot{{to_mm<72>(26.69), to_mm<72>(228.56), Center, "Bright Atten", ""}, -1, 1, 0.f},
		Trimpot{{to_mm<72>(63.55), to_mm<72>(228.56), Center, "Freq Atten", ""}, -1, 1, 0.f},
		Trimpot{{to_mm<72>(100.41), to_mm<72>(228.56), Center, "Damp Atten", ""}, -1, 1, 0.f},
		Trimpot{{to_mm<72>(137.28), to_mm<72>(228.56), Center, "Struct Atten", ""}, -1, 1, 0.f},
		Trimpot{{to_mm<72>(174.14), to_mm<72>(228.56), Center, "Pos Atten", ""}, -1, 1, 0.f},
