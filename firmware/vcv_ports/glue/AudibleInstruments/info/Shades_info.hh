...
struct ShadesInfo : ModuleInfoBase {
    ...
    static constexpr std::array<Element, 15> Elements{{
		...
		Toggle2pos{{to_mm<72>(16.27), to_mm<72>(59.415), Center, "Ch1 Mode", ""}, {"Attenuate", "Attenuvert"}, Toggle2pos::State_t::UP},
		Toggle2pos{{to_mm<72>(16.27), to_mm<72>(122.455), Center, "Ch2 Mode", ""}, {"Attenuate", "Attenuvert"}, Toggle2pos::State_t::UP},
		Toggle2pos{{to_mm<72>(16.27), to_mm<72>(185.475), Center, "Ch3 Mode", ""}, {"Attenuate", "Attenuvert"}, Toggle2pos::State_t::UP},
