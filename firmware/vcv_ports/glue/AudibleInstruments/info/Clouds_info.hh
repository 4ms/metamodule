...
struct CloudsInfo : ModuleInfoBase {
    ...
    static constexpr std::array<Element, 29> Elements{{
		...
		RedLargeKnob{{to_mm<72>(45.64), to_mm<72>(129.32), Center, "Position", ""}, 0, 1, 0.5f},
		BlueLargeKnob{{to_mm<72>(129.6), to_mm<72>(129.32), Center, "Size", ""}, 0, 1, 0.5f},
		WhiteLargeKnob{{to_mm<72>(212.77), to_mm<72>(129.32), Center, "Pitch", ""}, -2, 2, 0},
		RedMediumKnob{{to_mm<72>(93.83), to_mm<72>(54.99), Center, "In Gain", ""}, 0, 1, 0.5f},
		RedMediumKnob{{to_mm<72>(158.97), to_mm<72>(54.99), Center, "Density", ""}, 0, 1, 0.5f},
		BlueMediumKnob{{to_mm<72>(224.11), to_mm<72>(54.99), Center, "Texture", ""}, 0, 1, 0.5f},
		WhiteMediumKnob{{to_mm<72>(34.3), to_mm<72>(202.85), Center, "DryWet", ""}, 0, 1, 0.5f},
		WhiteMediumKnob{{to_mm<72>(97.57), to_mm<72>(202.85), Center, "Spread", ""}, 0, 1, 0.f},
		WhiteMediumKnob{{to_mm<72>(160.84), to_mm<72>(202.85), Center, "Feedback", ""}, 0, 1, 0.f},
		WhiteMediumKnob{{to_mm<72>(224.11), to_mm<72>(202.85), Center, "Reverb", ""}, 0, 1, 0.f},
