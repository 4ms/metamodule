...
struct StagesInfo : ModuleInfoBase {
    ...
    static constexpr std::array<Element, 48> Elements{{
		Trimpot{{to_mm<72>(19.38), to_mm<72>(48.44), Center, "Ch1 Shape", ""}, 0, 1, 0.5f, "", "%", 0, 100},
		Trimpot{{to_mm<72>(51.8), to_mm<72>(48.44), Center, "Ch2 Shape", ""}, 0, 1, 0.5f, "", "%", 0, 100},
		Trimpot{{to_mm<72>(84.23), to_mm<72>(48.44), Center, "Ch3 Shape", ""}, 0, 1, 0.5f, "", "%", 0, 100},
		Trimpot{{to_mm<72>(116.72), to_mm<72>(48.44), Center, "Ch4 Shape", ""}, 0, 1, 0.5f, "", "%", 0, 100},
		Trimpot{{to_mm<72>(149.15), to_mm<72>(48.44), Center, "Ch5 Shape", ""}, 0, 1, 0.5f, "", "%", 0, 100},
		Trimpot{{to_mm<72>(181.58), to_mm<72>(48.44), Center, "Ch6 Shape", ""}, 0, 1, 0.5f, "", "%", 0, 100},
		...
		GreenHandleSlider{{to_mm<72>(19.325), to_mm<72>(160.22), Center, "Ch1 Level Slider", ""}, 0, 1, 0.5f, "", "%", 0, 100},
		GreenHandleSlider{{to_mm<72>(51.795), to_mm<72>(160.22), Center, "Ch2 Level Slider", ""}, 0, 1, 0.5f, "", "%", 0, 100},
		GreenHandleSlider{{to_mm<72>(84.265), to_mm<72>(160.22), Center, "Ch3 Level Slider", ""}, 0, 1, 0.5f, "", "%", 0, 100},
		GreenHandleSlider{{to_mm<72>(116.675), to_mm<72>(160.22), Center, "Ch4 Level Slider", ""}, 0, 1, 0.5f, "", "%", 0, 100},
		GreenHandleSlider{{to_mm<72>(149.135), to_mm<72>(160.22), Center, "Ch5 Level Slider", ""}, 0, 1, 0.5f, "", "%", 0, 100},
		GreenHandleSlider{{to_mm<72>(181.605), to_mm<72>(160.22), Center, "Ch6 Level Slider", ""}, 0, 1, 0.5f, "", "%", 0, 100},
