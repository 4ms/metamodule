...
struct HighShelf {
  ...
  float a0_target = 1.f, a1_target = 0.f, a2_target = 0.f, b1_target = 0.f,
        b2_target = 0.f;
...
struct ListenClosely : Module {
  ...
  ListenClosely() {
    ...
    configSwitch(RATIO_PARAM, 0.f, 2.f, 0.f, "Ratio",
                 {"Compressor", "Bypass", "Limiter"});
    ...
    configSwitch(HIGHPASSFREQSELECT_PARAM, 0.f, 1.f, 0.f,
                 "Highpass Frequency Select");
  ...
  int highpassLEDs[5] = {OFFLED_LIGHT, _50LED_LIGHT, _80LED_LIGHT,
                         _160LED_LIGHT, _300LED_LIGHT};
  int lowShelfLEDs[4] = {_35LED_LIGHT, _60LED_LIGHT, _110LED_LIGHT,
                         _220LED_LIGHT};
  int midLEDs[6] = {_360LED_LIGHT, _700LED_LIGHT, _16KLED_LIGHT,
                    _32KLED_LIGHT, _48KLED_LIGHT, _72KLED_LIGHT};
  ...
  void process(const ProcessArgs &args) override {
    ...
    auto applyEQ = [&](float &L, float &R, const ProcessArgs &a) {
      ...
      static constexpr float midFreqs[6] = {360.f,  700.f,  1600.f,
                                            3200.f, 4800.f, 7200.f};
    ...
    if (prepostMode == 0) {
      ...
      lights[EQCLIPLED_LIGHT].setBrightnessSmooth(eqClipping ? 1.f : 0.f,
                                                  args.sampleTime);
    ...
    // --- Compressor ---
    {
      ...
      if (bypass) {
        ...
        compOutL =
            compInL * (1.f - dryWet) + compInL * gainReduction * gain * dryWet;
        compOutR =
            compInR * (1.f - dryWet) + compInR * gainReduction * gain * dryWet;
        compOutL = clamp(compOutL, -10.f, 10.f);
        compOutR = clamp(compOutR, -10.f, 10.f);
        const bool clipping =
            (fabsf(compOutL) >= 9.9f || fabsf(compOutR) >= 9.9f);
        lights[CLIPLED_LIGHT].setBrightnessSmooth(clipping ? 1.f : 0.f,
                                                  args.sampleTime);
        ...
        for (int i = 0; i < 9; i++) {
          int idx = GRAPH9_LIGHT - i;
          lights[idx].setBrightnessSmooth(i < numSegments ? 1.f : 0.f,
                                          args.sampleTime);
        }
      }
    }
...
struct ListenCloselyWidget : ModuleWidget {
  ListenCloselyWidget(ListenClosely *module) {
    ...
    setPanel(createPanel(
        asset::plugin(pluginInstance, "res/panels/ListenClosely_info.svg")));
    ...
    addParam(createParamCentered<_9mmKnob>(mm2px(Vec(12.256, 26.45)), module,
                                           ListenClosely::PEAKREDUCTION_PARAM));
    addParam(createParamCentered<_9mmKnob>(mm2px(Vec(58.538, 26.45)), module,
                                           ListenClosely::DRYWET_PARAM));
    addParam(createParamCentered<_9mmKnob>(mm2px(Vec(35.487, 37.026)), module,
                                           ListenClosely::GAIN_PARAM));

    addParam(createParamCentered<Davies1900hBlack>(
        mm2px(Vec(12.164, 47.733)), module, ListenClosely::LOWSHELF_PARAM));
    addParam(createParamCentered<Davies1900hBlack>(
        mm2px(Vec(58.693, 47.733)), module, ListenClosely::HIGHSHELF_PARAM));
    addParam(createParamCentered<Davies1900hBlack>(
        mm2px(Vec(35.582, 64.355)), module, ListenClosely::MID_PARAM));
    addParam(createParamCentered<Davies1900hBlack>(
        mm2px(Vec(12.299, 93.217)), module, ListenClosely::WIDTH_PARAM));
    addParam(createParamCentered<Davies1900hBlack>(
        mm2px(Vec(58.414, 93.263)), module, ListenClosely::OUTPUTVOL_PARAM));

    addParam(createParamCentered<LEDBezel>(mm2px(Vec(12.221, 69.566)), module,
                                           ListenClosely::LOWFREQSELECT_PARAM));
    addParam(
        createParamCentered<LEDBezel>(mm2px(Vec(58.376, 69.573)), module,
                                      ListenClosely::HIGHPASSFREQSELECT_PARAM));
    addParam(createParamCentered<LEDBezel>(mm2px(Vec(35.572, 86.054)), module,
                                           ListenClosely::MIDFREQSELECT_PARAM));

    addParam(createParamCentered<_3PosHorizontal>(
        mm2px(Vec(35.402, 100.566)), module, ListenClosely::PREPOST_PARAM));
    addParam(createParamCentered<_3PosHorizontal>(
        mm2px(Vec(35.381, 22.267)), module, ListenClosely::RATIO_PARAM));

    addInput(createInputCentered<PJ301MPort>(mm2px(Vec(8.963, 113.811)), module,
                                             ListenClosely::INL_INPUT));
    addInput(createInputCentered<PJ301MPort>(mm2px(Vec(19.969, 113.811)),
                                             module, ListenClosely::INR_INPUT));
    addInput(createInputCentered<PJ301MPort>(
        mm2px(Vec(35.529, 113.811)), module, ListenClosely::WIDTHCV_INPUT));
    addOutput(createOutputCentered<PJ301MPort>(
        mm2px(Vec(51.107, 113.811)), module, ListenClosely::OUTL_OUTPUT));
    addOutput(createOutputCentered<PJ301MPort>(
        mm2px(Vec(62.117, 113.811)), module, ListenClosely::OUTR_OUTPUT));

    addChild(createLightCentered<MediumLight<RedLight>>(
        mm2px(Vec(31, 49.2)), module, ListenClosely::CLIPLED_LIGHT));
    addChild(createLightCentered<MediumLight<RedLight>>(
        mm2px(Vec(63.5, 82.8)), module, ListenClosely::EQCLIPLED_LIGHT));

    addChild(createLightCentered<MediumLight<RedLight>>(
        mm2px(Vec(15.56, 14.72)), module, ListenClosely::GRAPH1_LIGHT));
    addChild(createLightCentered<MediumLight<RedLight>>(
        mm2px(Vec(20.562, 14.72)), module, ListenClosely::GRAPH2_LIGHT));
    addChild(createLightCentered<MediumLight<RedLight>>(
        mm2px(Vec(25.568, 14.72)), module, ListenClosely::GRAPH3_LIGHT));
...
Model *modelListenClosely =
    createModel<ListenClosely, ListenCloselyWidget>("ListenClosely");
