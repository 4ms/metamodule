 ...
 */
#define AHB_SRAM                                                                                                       \
	((uint32_t)0x30000000) /*!< Base address of : (up to 288KB) system data RAM accessible over over AHB */
#define AHB_RETRAM                                                                                                     \
	((uint32_t)0x38000000) /*!< Base address of : (up to 64KB) Retention RAM accessible over over AHB */

#define SYSRAM_BASE                                                                                                    \
	((uint32_t)0x2FFC0000) /*!< Base address of : (up to 256KB) System RAM accessible over over AXI */
#define RETRAM_BASE MCU_AHB_RETRAM
#define SRAM_BASE AHB_SRAM
#define PERIPH_BASE                                                                                                    \
	((uint32_t)0x40000000) /*!< Base address of : AHB/ABP Peripherals */
#define AXI_BUS_MEMORY_BASE                                                                                            \
	((uint32_t)0x60000000) /*!< Base address of : AXI Bus */

#define FMC_NOR_MEM_BASE                                                                                               \
	(AXI_BUS_MEMORY_BASE) /*!< Base address of : FMC NOR memories  accessible over AXI              */
#define QSPI_MEM_BASE                                                                                                  \
	(AXI_BUS_MEMORY_BASE + 0x10000000) /*!< Base address of : QSPI memories  accessible over AXI                 */
#define FMC_NAND_MEM_BASE                                                                                              \
	(AXI_BUS_MEMORY_BASE + 0x20000000) /*!< Base address of : FMC NAND memories  accessible over AXI             */
#define STM_DATA_BASE                                                                                                  \
	(AXI_BUS_MEMORY_BASE + 0x30000000) /*!< Base address of : STM Data accessible over AXI                       */
#define DRAM_MEM_BASE                                                                                                  \
	(AXI_BUS_MEMORY_BASE + 0x60000000) /*!< Base address of : DRAM (DDR) over AXI                                */
