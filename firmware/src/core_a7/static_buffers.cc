...
__attribute__((section(".ddma"))) IntercoreModuleFS::IccMessage icc_module_fs_message_core0;
__attribute__((section(".ddma"))) IntercoreModuleFS::IccMessage icc_module_fs_message_core1;
