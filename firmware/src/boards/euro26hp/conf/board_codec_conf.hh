...
using ExtCodecT = mdrivlib::CodecPCM3168;

struct Hardware {
	static inline mdrivlib::I2CPeriph i2c{a7m4_shared_i2c_conf};
	static inline CodecT codec{i2c, codec_mainPCB_sai_conf};	//44W (reg 88)
	static inline ExtCodecT codec_ext{i2c, codec_ext_sai_conf}; //45W (reg 8A)
