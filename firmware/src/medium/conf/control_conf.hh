...
struct TempAdcConf : mdrivlib::DefaultAdcPeriphConf {
	static constexpr mdrivlib::AdcResolution resolution = mdrivlib::Bits12;
...
constexpr auto TempChanConf = std::to_array({
	AdcChannelConf{{GPIO::Unused}, mdrivlib::AdcChanNum::Temp, 0, mdrivlib::AdcSamplingTime::_64Cycles},
});
