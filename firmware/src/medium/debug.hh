...
struct Debug {
	...
	using red_LED1 = mdrivlib::FPin<mdrivlib::GPIO::B, 15, mdrivlib::PinMode::Output>;
	using blue_LED1 = mdrivlib::FPin<mdrivlib::GPIO::A, 9, mdrivlib::PinMode::Output>;
	using green_LED1 = mdrivlib::FPin<mdrivlib::GPIO::E, 14, mdrivlib::PinMode::Output>;
