...
*/
#if 1
#define BINARY(sym) NOT_SUPPORTED_IN_METAMODULE
#define BINARY_START(sym) NOT_SUPPORTED_IN_METAMODULE
#define BINARY_END(sym) NOT_SUPPORTED_IN_METAMODULE
#define BINARY_SIZE(sym) NOT_SUPPORTED_IN_METAMODULE
...
Usage examples:
	...
	4.2e-4_f64
*/
inline int8_t operator"" _i8(unsigned long long x) {
	return x;
}
inline int16_t operator"" _i16(unsigned long long x) {
	return x;
}
inline int32_t operator"" _i32(unsigned long long x) {
	return x;
}
inline int64_t operator"" _i64(unsigned long long x) {
	return x;
}
inline uint8_t operator"" _u8(unsigned long long x) {
	return x;
}
inline uint16_t operator"" _u16(unsigned long long x) {
	return x;
}
inline uint32_t operator"" _u32(unsigned long long x) {
	return x;
}
inline uint64_t operator"" _u64(unsigned long long x) {
	return x;
}
inline float operator"" _f32(long double x) {
	return x;
}
inline float operator"" _f32(unsigned long long x) {
	return x;
}
inline double operator"" _f64(long double x) {
	return x;
}
inline double operator"" _f64(unsigned long long x) {
	return x;
}
...
get(const C &m, const typename C::key_type &key, const typename C::mapped_type &def = typename C::mapped_type()) {
