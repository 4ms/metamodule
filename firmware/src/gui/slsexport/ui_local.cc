...
void format_mapping_circle(lv_obj_t *circle, MapButtonType type, unsigned panel_jack_id) {
	...
	switch (type) {
		...
		case MapButtonType::Output:
			circle_bgcolor = mc(METACOLOR_GREY_MEDIUM);
...
// 		case MapButtonType::Output:
// 			circle_bg_style = mc_bg(METACOLOR_GREY_MEDIUM);
...
lv_obj_t *create_automap_item(lv_obj_t *parent, std::string_view name) {
	...
	lv_obj_add_style(automap_switch, scheme_bg(METACOLOR_GREY_MEDIUM), LV_PART_MAIN | LV_STATE_DEFAULT);
	lv_obj_set_style_bg_opa(automap_switch, 255, LV_PART_MAIN | LV_STATE_DEFAULT);

	lv_obj_add_style(automap_switch, scheme_bg(METACOLOR_GREY_MEDIUM), LV_PART_INDICATOR | LV_STATE_CHECKED);
...
lv_obj_t *create_labeled_check_obj(lv_obj_t *parent, const char *name) {
	...
	lv_obj_add_style(check, scheme_bg(METACOLOR_CHECKBOX), LV_PART_INDICATOR | LV_STATE_CHECKED);
...
lv_obj_t *create_lv_roller(lv_obj_t *parent) {
	...
	lv_obj_add_style(out, scheme_text(METACOLOR_DISABLED_TEXT), LV_PART_MAIN | LV_STATE_DEFAULT);
	...
	lv_obj_set_style_radius(out, 4, LV_PART_MAIN | LV_STATE_DEFAULT);
	lv_obj_add_style(out, scheme_bg(METACOLOR_DISABLED_BG), LV_PART_MAIN | LV_STATE_DEFAULT);
	lv_obj_set_style_bg_opa(out, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
	lv_obj_set_style_border_width(out, 2, LV_PART_MAIN | LV_STATE_DEFAULT);
	lv_obj_add_style(out, scheme_border(METACOLOR_GREY_MEDIUM), LV_PART_MAIN | LV_STATE_DEFAULT);
...
lv_obj_t *create_button(lv_obj_t *parent, const char *name) {
	...
	lv_obj_add_style(button, scheme_bg(METACOLOR_CONTROL_BG), LV_PART_MAIN | LV_STATE_DEFAULT);
	...
	lv_obj_set_align(label, LV_ALIGN_CENTER);
	lv_label_set_text(label, name);
	lv_obj_add_style(label, scheme_text(METACOLOR_CONTROL_TEXT), LV_PART_MAIN | LV_STATE_DEFAULT);
	lv_obj_set_style_text_opa(label, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
...
lv_obj_t *create_settings_menu_title(lv_obj_t *parent, std::string const &title_name) {
	...
	lv_obj_set_style_text_font(label, &ui_font_MuseoSansRounded70016, LV_PART_MAIN | LV_STATE_DEFAULT);
	lv_obj_add_style(label, scheme_border(METACOLOR_GREY_MEDIUM), LV_PART_MAIN | LV_STATE_DEFAULT);
...
lv_obj_t *create_settings_menu_switch(lv_obj_t *parent,
	...
	lv_obj_add_style(cont, scheme_border(METACOLOR_GREY_MEDIUM), LV_PART_MAIN | LV_STATE_DEFAULT);
	...
	lv_obj_add_style(onoff_switch, scheme_bg(METACOLOR_CHECKBOX), LV_PART_INDICATOR | LV_STATE_CHECKED);
...
lv_obj_t *create_settings_menu_slider(lv_obj_t *parent, std::string const &slider_text) {
	...
	lv_obj_add_style(slider_label, scheme_text(METACOLOR_GREY_BRIGHT), LV_PART_MAIN | LV_STATE_DISABLED);
	...
	lv_obj_add_style(slider, scheme_bg(METACOLOR_CHECKBOX), LV_PART_INDICATOR | LV_STATE_DEFAULT);
	lv_obj_set_style_bg_opa(slider, 255, LV_PART_INDICATOR | LV_STATE_DEFAULT);
	lv_obj_add_style(slider, scheme_border(METACOLOR_GREY_DARKEST), LV_PART_INDICATOR | LV_STATE_DEFAULT);
	...
	lv_obj_add_style(slider, scheme_border(METACOLOR_GREY_DARKEST), LV_PART_KNOB | LV_STATE_DEFAULT);
	...
	lv_obj_add_style(slider, scheme_outline(METACOLOR_GREY_DARKEST), LV_PART_KNOB | LV_STATE_DEFAULT);
...
lv_obj_t *create_midi_map_dropdown(lv_obj_t *parent, std::string const &options) {
	...
	// lv_obj_add_style(dropdown, mc_bg(METACOLOR_GREY_MEDIUM), LV_PART_MAIN);
...
lv_obj_t *create_button_expander_item(lv_obj_t *parent) {
	...
	lv_obj_add_style(circle, scheme_border(METACOLOR_GREY_MEDIUM), LV_PART_MAIN | LV_STATE_DEFAULT);
...
lv_obj_t *create_prefs_note(lv_obj_t *parent, std::string_view label_text) {
	...
	lv_obj_add_style(cont, scheme_text(METACOLOR_GREY_BRIGHTER), LV_PART_MAIN);
...
lv_obj_t *create_save_revert_buttons(lv_obj_t *parent) {
	...
	lv_obj_add_style(revert_button, scheme_bg(METACOLOR_GREY_MEDIUM), LV_PART_MAIN | LV_STATE_DEFAULT);
	...
	lv_obj_add_style(save_button, scheme_bg(METACOLOR_BUTTON_CONFIRM), LV_PART_MAIN | LV_STATE_DEFAULT);
...
lv_obj_t *create_load_meter(lv_obj_t *parent) {
	...
	lv_obj_add_style(load_meter, scheme_bg(METACOLOR_GREY_DARKEST), LV_PART_MAIN | LV_STATE_DEFAULT);
