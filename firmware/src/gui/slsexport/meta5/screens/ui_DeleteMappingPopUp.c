...
lv_obj_set_style_bg_color(ui_MessagePanel, MC(METACOLOR_POPUP_WARNING_BG), LV_PART_MAIN | LV_STATE_DEFAULT );
...
lv_obj_set_style_text_color(ui_MessageLabel, MC(METACOLOR_BLACK), LV_PART_MAIN | LV_STATE_DEFAULT );
