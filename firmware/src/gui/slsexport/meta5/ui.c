...
lv_obj_t *ui_KnobSetNameText1;
lv_obj_t *ui_KnobSetDescript1;
lv_obj_t *ui_KnobSetPanelLeft;
lv_obj_t *ui_Panel1;
lv_obj_t *ui_KnobContainerU;
lv_obj_t *ui_KnobU;
lv_obj_t *ui_CircleU;
lv_obj_t *ui_KnobLetterU;
lv_obj_t *ui_LabelU;
lv_obj_t *ui_KnobContainerU1;
lv_obj_t *ui_KnobU1;
lv_obj_t *ui_CircleU1;
lv_obj_t *ui_KnobLetterU1;
lv_obj_t *ui_LabelU1;
lv_obj_t *ui_KnobContainerV;
lv_obj_t *ui_KnobV;
lv_obj_t *ui_CircleV;
lv_obj_t *ui_KnobLetterV;
lv_obj_t *ui_LabelV;
lv_obj_t *ui_KnobContainerW;
lv_obj_t *ui_KnobW;
lv_obj_t *ui_CircleW;
lv_obj_t *ui_KnobLetterW;
lv_obj_t *ui_LabelW;
lv_obj_t *ui_KnobSetPanel;
lv_obj_t *ui_KnobContainerA;
lv_obj_t *ui_KnobA;
lv_obj_t *ui_CircleA;
lv_obj_t *ui_KnobLetterA;
lv_obj_t *ui_LabelA;
lv_obj_t *ui_KnobContainerB;
lv_obj_t *ui_KnobB;
lv_obj_t *ui_CircleB;
lv_obj_t *ui_KnobLetterB;
lv_obj_t *ui_LabelB;
lv_obj_t *ui_KnobContainerC;
lv_obj_t *ui_KnobC;
lv_obj_t *ui_CircleC;
lv_obj_t *ui_KnobLetterC;
lv_obj_t *ui_LabelC;
lv_obj_t *ui_KnobContainerD;
lv_obj_t *ui_KnobD;
lv_obj_t *ui_CircleD;
lv_obj_t *ui_KnobLetterD;
lv_obj_t *ui_LabelD;
lv_obj_t *ui_KnobContainerE;
lv_obj_t *ui_KnobE;
lv_obj_t *ui_CircleE;
lv_obj_t *ui_KnobLetterE;
lv_obj_t *ui_LabelE;
lv_obj_t *ui_KnobContainerF;
lv_obj_t *ui_KnobF;
lv_obj_t *ui_CircleF;
lv_obj_t *ui_KnobLetterF;
lv_obj_t *ui_LabelF;
lv_obj_t *ui_KnobSetPanelRight;
lv_obj_t *ui_KnobContainerX;
lv_obj_t *ui_KnobX;
lv_obj_t *ui_CircleX;
lv_obj_t *ui_KnobLetterX;
lv_obj_t *ui_LabelX;
lv_obj_t *ui_KnobContainerY;
lv_obj_t *ui_KnobY;
lv_obj_t *ui_CircleY;
lv_obj_t *ui_KnobLetterY;
lv_obj_t *ui_LabelY;
lv_obj_t *ui_KnobContainerZ;
lv_obj_t *ui_KnobZ;
lv_obj_t *ui_CircleZ;
lv_obj_t *ui_KnobLetterZ;
lv_obj_t *ui_LabelZ;
