...
const lv_img_dsc_t *get_img(const Davies1900hWhiteKnob &, uint32_t scale_px) {
	pr_dbg("get_img->Davies1900hWhiteKnob\n");
	return scale_px == 240 ? &Davies1900hWhite_240 : &Davies1900hWhite_120;
}

const lv_img_dsc_t *get_img(const Davies1900hRedKnob &, uint32_t scale_px) {
	pr_dbg("get_img->Davies1900hRedKnob\n");
	return scale_px == 240 ? &Davies1900hRed_240 : &Davies1900hRed_120;
}

const lv_img_dsc_t *get_img(const BefacoInputPort &, uint32_t scale_px) {
	pr_dbg("get_img->BananaRed\n");
	return scale_px == 240 ? &BananaBlack_240 : &BananaBlack_120;
}

const lv_img_dsc_t *get_img(const BefacoOutputPort &, uint32_t scale_px) {
	pr_dbg("get_img->BananaRed\n");
	return scale_px == 240 ? &BananaRed_240 : &BananaRed_120;
}

const lv_img_dsc_t *get_img(const MediumLight<RedGreenBlueLight> &, uint32_t scale_px) {
