...
struct PatchSelectorPage : PageBase {
	...
	void init() override
	{
		...
		lv_style_set_text_font(
			&style_patch_selector_patchlist_main, LV_STATE_DEFAULT, &lv_font_MuseoSansCondensed_700_13);
		...
		lv_style_set_text_font(
			&style_patch_selector_patchlist_selected, LV_STATE_DEFAULT, &lv_font_MuseoSansCondensed_700_13);
		...
		lv_style_set_text_font(
			&style_patch_selector_patchlist_list, LV_STATE_DEFAULT, &lv_font_MuseoSansCondensed_700_13);
