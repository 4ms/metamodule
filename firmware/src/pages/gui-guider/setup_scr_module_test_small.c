...
void setup_scr_module_test_small(lv_ui *ui) {
	...
	//Write codes module_test_small_SMR_panel
	ui->module_test_small_SMR_panel = lv_img_create(ui->module_test_small, NULL);

	//Write style LV_IMG_PART_MAIN for module_test_small_SMR_panel
	static lv_style_t style_module_test_small_SMR_panel_main;
	lv_style_reset(&style_module_test_small_SMR_panel_main);

	//Write style state: LV_STATE_DEFAULT for style_module_test_small_SMR_panel_main
	lv_style_set_image_recolor(
		&style_module_test_small_SMR_panel_main, LV_STATE_DEFAULT, lv_color_make(0xff, 0xff, 0xff));
	lv_style_set_image_recolor_opa(&style_module_test_small_SMR_panel_main, LV_STATE_DEFAULT, 0);
	lv_style_set_image_opa(&style_module_test_small_SMR_panel_main, LV_STATE_DEFAULT, 255);
	lv_obj_add_style(ui->module_test_small_SMR_panel, LV_IMG_PART_MAIN, &style_module_test_small_SMR_panel_main);
	lv_obj_set_pos(ui->module_test_small_SMR_panel, 0, 0);
	lv_obj_set_size(ui->module_test_small_SMR_panel, 246, 240);
	lv_obj_set_click(ui->module_test_small_SMR_panel, true);
	// lv_img_set_src(ui->module_test_small_SMR_panel,&_module_graphic_SMR_small_alpha_246x240);
	lv_img_set_pivot(ui->module_test_small_SMR_panel, 0, 0);
	lv_img_set_angle(ui->module_test_small_SMR_panel, 0);
	...
	lv_style_set_bg_grad_color(
		&style_module_test_small_freq_nudge1_main, LV_STATE_DEFAULT, lv_color_make(0xff, 0xff, 0xff));
	...
	lv_style_set_outline_color(
		&style_module_test_small_freq_nudge1_main, LV_STATE_DEFAULT, lv_color_make(0xff, 0xd6, 0x00));
	...
	lv_obj_set_style_local_text_color(
		ui->module_test_small_freq_nudge1_label, LV_LABEL_PART_MAIN, LV_STATE_DEFAULT, lv_color_make(0xff, 0xc3, 0x70));
	...
	lv_style_set_bg_grad_color(
		&style_module_test_small_freq_cv1_main, LV_STATE_DEFAULT, lv_color_make(0xff, 0xff, 0xff));
	...
	lv_style_set_border_color(
		&style_module_test_small_freq_cv1_main, LV_STATE_DEFAULT, lv_color_make(0xff, 0xc3, 0x70));
	...
	lv_obj_set_style_local_text_color(
		ui->module_test_small_freq_cv1_label, LV_LABEL_PART_MAIN, LV_STATE_DEFAULT, lv_color_make(0xff, 0xc3, 0x70));
	...
	lv_obj_set_style_local_text_color(
		ui->module_test_small_lock1_label, LV_LABEL_PART_MAIN, LV_STATE_DEFAULT, lv_color_make(0xff, 0xc3, 0x70));
	...
	lv_style_set_bg_color(
		&style_module_test_small_freq_switch1_main, LV_STATE_DEFAULT, lv_color_make(0xff, 0xff, 0xff));
	lv_style_set_bg_grad_color(
		&style_module_test_small_freq_switch1_main, LV_STATE_DEFAULT, lv_color_make(0xff, 0xff, 0xff));
	...
	lv_style_set_border_color(
		&style_module_test_small_freq_switch1_main, LV_STATE_DEFAULT, lv_color_make(0xff, 0xc3, 0x70));
	...
	lv_obj_set_style_local_text_color(ui->module_test_small_freq_switch1_label,
									  LV_LABEL_PART_MAIN,
									  LV_STATE_DEFAULT,
									  lv_color_make(0xff, 0xc3, 0x70));
	...
	lv_style_set_bg_color(
		&style_module_test_small_button_lock1_main, LV_STATE_DEFAULT, lv_color_make(0xff, 0xff, 0xff));
	lv_style_set_bg_grad_color(
		&style_module_test_small_button_lock1_main, LV_STATE_DEFAULT, lv_color_make(0xff, 0xff, 0xff));
	...
	lv_style_set_border_color(
		&style_module_test_small_button_lock1_main, LV_STATE_DEFAULT, lv_color_make(0xff, 0xc3, 0x70));
	...
	lv_obj_set_style_local_text_color(ui->module_test_small_button_lock1_label,
									  LV_LABEL_PART_MAIN,
									  LV_STATE_DEFAULT,
									  lv_color_make(0xff, 0xc3, 0x70));
	...
	lv_style_set_bg_color(
		&style_module_test_small_button_lock2_main, LV_STATE_DEFAULT, lv_color_make(0xff, 0xff, 0xff));
	lv_style_set_bg_grad_color(
		&style_module_test_small_button_lock2_main, LV_STATE_DEFAULT, lv_color_make(0xff, 0xff, 0xff));
	...
	lv_style_set_border_color(
		&style_module_test_small_button_lock2_main, LV_STATE_DEFAULT, lv_color_make(0xff, 0xc3, 0x70));
	...
	lv_obj_set_style_local_text_color(ui->module_test_small_button_lock2_label,
									  LV_LABEL_PART_MAIN,
									  LV_STATE_DEFAULT,
									  lv_color_make(0xff, 0xc3, 0x70));
	...
	lv_style_set_bg_color(
		&style_module_test_small_button_lock3_main, LV_STATE_DEFAULT, lv_color_make(0xff, 0xff, 0xff));
	lv_style_set_bg_grad_color(
		&style_module_test_small_button_lock3_main, LV_STATE_DEFAULT, lv_color_make(0xff, 0xff, 0xff));
	...
	lv_style_set_border_color(
		&style_module_test_small_button_lock3_main, LV_STATE_DEFAULT, lv_color_make(0xff, 0xc3, 0x70));
	...
	lv_obj_set_style_local_text_color(ui->module_test_small_button_lock3_label,
									  LV_LABEL_PART_MAIN,
									  LV_STATE_DEFAULT,
									  lv_color_make(0xff, 0xc3, 0x70));
	...
	lv_style_set_bg_color(
		&style_module_test_small_button_lock4_main, LV_STATE_DEFAULT, lv_color_make(0xff, 0xff, 0xff));
	lv_style_set_bg_grad_color(
		&style_module_test_small_button_lock4_main, LV_STATE_DEFAULT, lv_color_make(0xff, 0xff, 0xff));
	...
	lv_style_set_border_color(
		&style_module_test_small_button_lock4_main, LV_STATE_DEFAULT, lv_color_make(0xff, 0xc3, 0x70));
	...
	lv_obj_set_style_local_text_color(ui->module_test_small_button_lock4_label,
									  LV_LABEL_PART_MAIN,
									  LV_STATE_DEFAULT,
									  lv_color_make(0xff, 0xc3, 0x70));
	...
	lv_style_set_bg_color(
		&style_module_test_small_button_lock5_main, LV_STATE_DEFAULT, lv_color_make(0xff, 0xff, 0xff));
	lv_style_set_bg_grad_color(
		&style_module_test_small_button_lock5_main, LV_STATE_DEFAULT, lv_color_make(0xff, 0xff, 0xff));
	...
	lv_style_set_border_color(
		&style_module_test_small_button_lock5_main, LV_STATE_DEFAULT, lv_color_make(0xff, 0xc3, 0x70));
	...
	lv_obj_set_style_local_text_color(ui->module_test_small_button_lock5_label,
									  LV_LABEL_PART_MAIN,
									  LV_STATE_DEFAULT,
									  lv_color_make(0xff, 0xc3, 0x70));
	...
	lv_style_set_bg_color(
		&style_module_test_small_button_lock6_main, LV_STATE_DEFAULT, lv_color_make(0xff, 0xff, 0xff));
	lv_style_set_bg_grad_color(
		&style_module_test_small_button_lock6_main, LV_STATE_DEFAULT, lv_color_make(0xff, 0xff, 0xff));
	...
	lv_style_set_border_color(
		&style_module_test_small_button_lock6_main, LV_STATE_DEFAULT, lv_color_make(0xff, 0xc3, 0x70));
	...
	lv_obj_set_style_local_text_color(ui->module_test_small_button_lock6_label,
									  LV_LABEL_PART_MAIN,
									  LV_STATE_DEFAULT,
									  lv_color_make(0xff, 0xc3, 0x70));
	...
	lv_style_set_bg_grad_color(
		&style_module_test_small_freq_nudge2_main, LV_STATE_DEFAULT, lv_color_make(0xff, 0xff, 0xff));
	...
	lv_style_set_border_color(
		&style_module_test_small_freq_nudge2_main, LV_STATE_DEFAULT, lv_color_make(0xff, 0xc3, 0x70));
	...
	lv_obj_set_style_local_text_color(
		ui->module_test_small_freq_nudge2_label, LV_LABEL_PART_MAIN, LV_STATE_DEFAULT, lv_color_make(0xff, 0xc3, 0x70));
	...
	lv_style_set_bg_grad_color(
		&style_module_test_small_freq_cv2_main, LV_STATE_DEFAULT, lv_color_make(0xff, 0xff, 0xff));
	...
	lv_style_set_border_color(
		&style_module_test_small_freq_cv2_main, LV_STATE_DEFAULT, lv_color_make(0xff, 0xc3, 0x70));
	...
	lv_obj_set_style_local_text_color(
		ui->module_test_small_freq_cv2_label, LV_LABEL_PART_MAIN, LV_STATE_DEFAULT, lv_color_make(0xff, 0xc3, 0x70));
	...
	lv_obj_set_style_local_text_color(
		ui->module_test_small_lock2_label, LV_LABEL_PART_MAIN, LV_STATE_DEFAULT, lv_color_make(0xff, 0xc3, 0x70));
	...
	lv_style_set_bg_color(
		&style_module_test_small_freq_switch2_main, LV_STATE_DEFAULT, lv_color_make(0xff, 0xff, 0xff));
	lv_style_set_bg_grad_color(
		&style_module_test_small_freq_switch2_main, LV_STATE_DEFAULT, lv_color_make(0xff, 0xff, 0xff));
	...
	lv_style_set_border_color(
		&style_module_test_small_freq_switch2_main, LV_STATE_DEFAULT, lv_color_make(0xff, 0xc3, 0x70));
	...
	lv_obj_set_style_local_text_color(ui->module_test_small_freq_switch2_label,
									  LV_LABEL_PART_MAIN,
									  LV_STATE_DEFAULT,
									  lv_color_make(0xff, 0xc3, 0x70));
	...
	lv_style_set_bg_grad_color(
		&style_module_test_small_slider1_main, LV_STATE_DEFAULT, lv_color_make(0xff, 0xff, 0xff));
	...
	lv_style_set_outline_color(
		&style_module_test_small_slider1_main, LV_STATE_DEFAULT, lv_color_make(0xff, 0xc3, 0x70));
	...
	lv_obj_set_style_local_text_color(
		ui->module_test_small_slider1_label, LV_LABEL_PART_MAIN, LV_STATE_DEFAULT, lv_color_make(0xff, 0xc3, 0x70));
	...
	lv_style_set_bg_grad_color(
		&style_module_test_small_slider2_main, LV_STATE_DEFAULT, lv_color_make(0xff, 0xff, 0xff));
	...
	lv_style_set_outline_color(
		&style_module_test_small_slider2_main, LV_STATE_DEFAULT, lv_color_make(0xff, 0xc3, 0x70));
	...
	lv_obj_set_style_local_text_color(
		ui->module_test_small_slider2_label, LV_LABEL_PART_MAIN, LV_STATE_DEFAULT, lv_color_make(0xff, 0xc3, 0x70));
	...
	lv_style_set_bg_grad_color(
		&style_module_test_small_slider3_main, LV_STATE_DEFAULT, lv_color_make(0xff, 0xff, 0xff));
	...
	lv_style_set_outline_color(
		&style_module_test_small_slider3_main, LV_STATE_DEFAULT, lv_color_make(0xff, 0xc3, 0x70));
	...
	lv_obj_set_style_local_text_color(
		ui->module_test_small_slider3_label, LV_LABEL_PART_MAIN, LV_STATE_DEFAULT, lv_color_make(0xff, 0xc3, 0x70));
	...
	lv_style_set_bg_grad_color(
		&style_module_test_small_slider4_main, LV_STATE_DEFAULT, lv_color_make(0xff, 0xff, 0xff));
	...
	lv_style_set_outline_color(
		&style_module_test_small_slider4_main, LV_STATE_DEFAULT, lv_color_make(0xff, 0xc3, 0x70));
	...
	lv_obj_set_style_local_text_color(
		ui->module_test_small_slider4_label, LV_LABEL_PART_MAIN, LV_STATE_DEFAULT, lv_color_make(0xff, 0xc3, 0x70));
	...
	lv_style_set_bg_grad_color(
		&style_module_test_small_slider5_main, LV_STATE_DEFAULT, lv_color_make(0xff, 0xff, 0xff));
	...
	lv_style_set_outline_color(
		&style_module_test_small_slider5_main, LV_STATE_DEFAULT, lv_color_make(0xff, 0xc3, 0x70));
	...
	lv_obj_set_style_local_text_color(
		ui->module_test_small_slider5_label, LV_LABEL_PART_MAIN, LV_STATE_DEFAULT, lv_color_make(0xff, 0xc3, 0x70));
	...
	lv_style_set_bg_grad_color(
		&style_module_test_small_slider6_main, LV_STATE_DEFAULT, lv_color_make(0xff, 0xff, 0xff));
	...
	lv_style_set_outline_color(
		&style_module_test_small_slider6_main, LV_STATE_DEFAULT, lv_color_make(0xff, 0xc3, 0x70));
	...
	lv_obj_set_style_local_text_color(
		ui->module_test_small_slider6_label, LV_LABEL_PART_MAIN, LV_STATE_DEFAULT, lv_color_make(0xff, 0xc3, 0x70));
	...
	lv_style_set_bg_color(
		&style_module_test_small_switch_cv_slew_main, LV_STATE_DEFAULT, lv_color_make(0xff, 0xff, 0xff));
	lv_style_set_bg_grad_color(
		&style_module_test_small_switch_cv_slew_main, LV_STATE_DEFAULT, lv_color_make(0xff, 0xff, 0xff));
	...
	lv_style_set_border_color(
		&style_module_test_small_switch_cv_slew_main, LV_STATE_DEFAULT, lv_color_make(0xff, 0xc3, 0x70));
	...
	lv_obj_add_style(
		ui->module_test_small_switch_cv_slew, LV_BTN_PART_MAIN, &style_module_test_small_switch_cv_slew_main);
	...
	lv_obj_set_style_local_text_color(ui->module_test_small_switch_cv_slew_label,
									  LV_LABEL_PART_MAIN,
									  LV_STATE_DEFAULT,
									  lv_color_make(0xff, 0xc3, 0x70));
	...
	lv_style_set_bg_grad_color(
		&style_module_test_small_lvl_cv1_main, LV_STATE_DEFAULT, lv_color_make(0xff, 0xff, 0xff));
	...
	lv_style_set_outline_color(
		&style_module_test_small_lvl_cv1_main, LV_STATE_DEFAULT, lv_color_make(0xff, 0xc3, 0x70));
	...
	lv_obj_set_style_local_text_color(
		ui->module_test_small_lvl_cv1_label, LV_LABEL_PART_MAIN, LV_STATE_DEFAULT, lv_color_make(0xff, 0xc3, 0x70));
	...
	lv_style_set_bg_grad_color(
		&style_module_test_small_lvl_cv2_main, LV_STATE_DEFAULT, lv_color_make(0xff, 0xff, 0xff));
	...
	lv_style_set_outline_color(
		&style_module_test_small_lvl_cv2_main, LV_STATE_DEFAULT, lv_color_make(0xff, 0xc3, 0x70));
	...
	lv_obj_set_style_local_text_color(
		ui->module_test_small_lvl_cv2_label, LV_LABEL_PART_MAIN, LV_STATE_DEFAULT, lv_color_make(0xff, 0xc3, 0x70));
	...
	lv_style_set_bg_grad_color(
		&style_module_test_small_lvl_cv3_main, LV_STATE_DEFAULT, lv_color_make(0xff, 0xff, 0xff));
	...
	lv_style_set_outline_color(
		&style_module_test_small_lvl_cv3_main, LV_STATE_DEFAULT, lv_color_make(0xff, 0xc3, 0x70));
	...
	lv_obj_set_style_local_text_color(
		ui->module_test_small_lvl_cv3_label, LV_LABEL_PART_MAIN, LV_STATE_DEFAULT, lv_color_make(0xff, 0xc3, 0x70));
	...
	lv_style_set_bg_grad_color(
		&style_module_test_small_lvl_cv4_main, LV_STATE_DEFAULT, lv_color_make(0xff, 0xff, 0xff));
	...
	lv_style_set_outline_color(
		&style_module_test_small_lvl_cv4_main, LV_STATE_DEFAULT, lv_color_make(0xff, 0xc3, 0x70));
	...
	lv_obj_set_style_local_text_color(
		ui->module_test_small_lvl_cv4_label, LV_LABEL_PART_MAIN, LV_STATE_DEFAULT, lv_color_make(0xff, 0xc3, 0x70));
	...
	lv_style_set_bg_grad_color(
		&style_module_test_small_lvl_cv5_main, LV_STATE_DEFAULT, lv_color_make(0xff, 0xff, 0xff));
	...
	lv_style_set_outline_color(
		&style_module_test_small_lvl_cv5_main, LV_STATE_DEFAULT, lv_color_make(0xff, 0xc3, 0x70));
	...
	lv_obj_set_style_local_text_color(
		ui->module_test_small_lvl_cv5_label, LV_LABEL_PART_MAIN, LV_STATE_DEFAULT, lv_color_make(0xff, 0xc3, 0x70));
	...
	lv_style_set_bg_grad_color(
		&style_module_test_small_lvl_cv6_main, LV_STATE_DEFAULT, lv_color_make(0xff, 0xff, 0xff));
	...
	lv_style_set_outline_color(
		&style_module_test_small_lvl_cv6_main, LV_STATE_DEFAULT, lv_color_make(0xff, 0xc3, 0x70));
	...
	lv_obj_set_style_local_text_color(
		ui->module_test_small_lvl_cv6_label, LV_LABEL_PART_MAIN, LV_STATE_DEFAULT, lv_color_make(0xff, 0xc3, 0x70));
	...
	lv_style_set_bg_grad_color(
		&style_module_test_small_env_out1_main, LV_STATE_DEFAULT, lv_color_make(0xff, 0xff, 0xff));
	...
	lv_style_set_border_color(
		&style_module_test_small_env_out1_main, LV_STATE_DEFAULT, lv_color_make(0xff, 0xc3, 0x70));
	...
	lv_obj_set_style_local_text_color(
		ui->module_test_small_env_out1_label, LV_LABEL_PART_MAIN, LV_STATE_DEFAULT, lv_color_make(0xff, 0xc3, 0x70));
	...
	lv_style_set_bg_grad_color(
		&style_module_test_small_env_out2_main, LV_STATE_DEFAULT, lv_color_make(0xff, 0xff, 0xff));
	...
	lv_style_set_border_color(
		&style_module_test_small_env_out2_main, LV_STATE_DEFAULT, lv_color_make(0xff, 0xc3, 0x70));
	...
	lv_obj_set_style_local_text_color(
		ui->module_test_small_env_out2_label, LV_LABEL_PART_MAIN, LV_STATE_DEFAULT, lv_color_make(0xff, 0xc3, 0x70));
	...
	lv_style_set_bg_grad_color(
		&style_module_test_small_env_out3_main, LV_STATE_DEFAULT, lv_color_make(0xff, 0xff, 0xff));
	...
	lv_style_set_border_color(
		&style_module_test_small_env_out3_main, LV_STATE_DEFAULT, lv_color_make(0xff, 0xc3, 0x70));
	...
	lv_obj_set_style_local_text_color(
		ui->module_test_small_env_out3_label, LV_LABEL_PART_MAIN, LV_STATE_DEFAULT, lv_color_make(0xff, 0xc3, 0x70));
	...
	lv_style_set_bg_grad_color(
		&style_module_test_small_rotate_cv_main, LV_STATE_DEFAULT, lv_color_make(0xff, 0xff, 0xff));
	...
	lv_style_set_border_color(
		&style_module_test_small_rotate_cv_main, LV_STATE_DEFAULT, lv_color_make(0xff, 0xc3, 0x70));
	...
	lv_obj_set_style_local_text_color(
		ui->module_test_small_rotate_cv_label, LV_LABEL_PART_MAIN, LV_STATE_DEFAULT, lv_color_make(0xff, 0xc3, 0x70));
	...
	lv_style_set_bg_grad_color(
		&style_module_test_small_env_out4_main, LV_STATE_DEFAULT, lv_color_make(0xff, 0xff, 0xff));
	...
	lv_style_set_border_color(
		&style_module_test_small_env_out4_main, LV_STATE_DEFAULT, lv_color_make(0xff, 0xc3, 0x70));
	...
	lv_obj_set_style_local_text_color(
		ui->module_test_small_env_out4_label, LV_LABEL_PART_MAIN, LV_STATE_DEFAULT, lv_color_make(0xff, 0xc3, 0x70));
	...
	lv_style_set_bg_grad_color(
		&style_module_test_small_env_out5_main, LV_STATE_DEFAULT, lv_color_make(0xff, 0xff, 0xff));
	...
	lv_style_set_border_color(
		&style_module_test_small_env_out5_main, LV_STATE_DEFAULT, lv_color_make(0xff, 0xc3, 0x70));
	...
	lv_obj_set_style_local_text_color(
		ui->module_test_small_env_out5_label, LV_LABEL_PART_MAIN, LV_STATE_DEFAULT, lv_color_make(0xff, 0xc3, 0x70));
	...
	lv_style_set_bg_grad_color(
		&style_module_test_small_env_out6_main, LV_STATE_DEFAULT, lv_color_make(0xff, 0xff, 0xff));
	...
	lv_style_set_border_color(
		&style_module_test_small_env_out6_main, LV_STATE_DEFAULT, lv_color_make(0xff, 0xc3, 0x70));
	...
	lv_obj_set_style_local_text_color(
		ui->module_test_small_env_out6_label, LV_LABEL_PART_MAIN, LV_STATE_DEFAULT, lv_color_make(0xff, 0xc3, 0x70));
	...
	lv_style_set_bg_color(
		&style_module_test_small_post_pre_switch_main, LV_STATE_DEFAULT, lv_color_make(0xff, 0xff, 0xff));
	lv_style_set_bg_grad_color(
		&style_module_test_small_post_pre_switch_main, LV_STATE_DEFAULT, lv_color_make(0xff, 0xff, 0xff));
	...
	lv_style_set_border_color(
		&style_module_test_small_post_pre_switch_main, LV_STATE_DEFAULT, lv_color_make(0xff, 0xc3, 0x70));
	...
	lv_obj_add_style(
		ui->module_test_small_post_pre_switch, LV_BTN_PART_MAIN, &style_module_test_small_post_pre_switch_main);
	...
	lv_obj_set_style_local_text_color(ui->module_test_small_post_pre_switch_label,
									  LV_LABEL_PART_MAIN,
									  LV_STATE_DEFAULT,
									  lv_color_make(0xff, 0xc3, 0x70));
	...
	lv_style_set_bg_color(
		&style_module_test_small_fast_slow_switch_main, LV_STATE_DEFAULT, lv_color_make(0xff, 0xff, 0xff));
	lv_style_set_bg_grad_color(
		&style_module_test_small_fast_slow_switch_main, LV_STATE_DEFAULT, lv_color_make(0xff, 0xff, 0xff));
	...
	lv_style_set_border_color(
		&style_module_test_small_fast_slow_switch_main, LV_STATE_DEFAULT, lv_color_make(0xff, 0xc3, 0x70));
	...
	lv_obj_add_style(
		ui->module_test_small_fast_slow_switch, LV_BTN_PART_MAIN, &style_module_test_small_fast_slow_switch_main);
	...
	lv_obj_set_style_local_text_color(ui->module_test_small_fast_slow_switch_label,
									  LV_LABEL_PART_MAIN,
									  LV_STATE_DEFAULT,
									  lv_color_make(0xff, 0xc3, 0x70));
	...
	lv_style_set_bg_grad_color(
		&style_module_test_small_input_odds_main, LV_STATE_DEFAULT, lv_color_make(0xff, 0xff, 0xff));
	...
	lv_style_set_border_color(
		&style_module_test_small_input_odds_main, LV_STATE_DEFAULT, lv_color_make(0xff, 0xc3, 0x70));
	...
	lv_obj_set_style_local_text_color(
		ui->module_test_small_input_odds_label, LV_LABEL_PART_MAIN, LV_STATE_DEFAULT, lv_color_make(0xff, 0xc3, 0x70));
	...
	lv_style_set_bg_grad_color(
		&style_module_test_small_input_evens_main, LV_STATE_DEFAULT, lv_color_make(0xff, 0xff, 0xff));
	...
	lv_style_set_border_color(
		&style_module_test_small_input_evens_main, LV_STATE_DEFAULT, lv_color_make(0xff, 0xc3, 0x70));
	...
	lv_obj_set_style_local_text_color(
		ui->module_test_small_input_evens_label, LV_LABEL_PART_MAIN, LV_STATE_DEFAULT, lv_color_make(0xff, 0xc3, 0x70));
	...
	lv_style_set_bg_color(
		&style_module_test_small_rotate_trig_cntr_main, LV_STATE_DEFAULT, lv_color_make(0xff, 0xff, 0xff));
	lv_style_set_bg_grad_color(
		&style_module_test_small_rotate_trig_cntr_main, LV_STATE_DEFAULT, lv_color_make(0xff, 0xff, 0xff));
	...
	lv_style_set_border_color(
		&style_module_test_small_rotate_trig_cntr_main, LV_STATE_DEFAULT, lv_color_make(0xff, 0xc3, 0x70));
	...
	lv_obj_add_style(
		ui->module_test_small_rotate_trig_cntr, LV_BTN_PART_MAIN, &style_module_test_small_rotate_trig_cntr_main);
	...
	lv_obj_set_style_local_text_color(ui->module_test_small_rotate_trig_cntr_label,
									  LV_LABEL_PART_MAIN,
									  LV_STATE_DEFAULT,
									  lv_color_make(0xff, 0xc3, 0x70));
	...
	lv_style_set_bg_color(
		&style_module_test_small_rotate_trig_clkw_main, LV_STATE_DEFAULT, lv_color_make(0xff, 0xff, 0xff));
	lv_style_set_bg_grad_color(
		&style_module_test_small_rotate_trig_clkw_main, LV_STATE_DEFAULT, lv_color_make(0xff, 0xff, 0xff));
	...
	lv_style_set_border_color(
		&style_module_test_small_rotate_trig_clkw_main, LV_STATE_DEFAULT, lv_color_make(0xff, 0xc3, 0x70));
	...
	lv_obj_add_style(
		ui->module_test_small_rotate_trig_clkw, LV_BTN_PART_MAIN, &style_module_test_small_rotate_trig_clkw_main);
	...
	lv_obj_set_style_local_text_color(ui->module_test_small_rotate_trig_clkw_label,
									  LV_LABEL_PART_MAIN,
									  LV_STATE_DEFAULT,
									  lv_color_make(0xff, 0xc3, 0x70));
	...
	lv_style_set_bg_grad_color(
		&style_module_test_small_output_odds_main, LV_STATE_DEFAULT, lv_color_make(0xff, 0xff, 0xff));
	...
	lv_style_set_border_color(
		&style_module_test_small_output_odds_main, LV_STATE_DEFAULT, lv_color_make(0xff, 0xc3, 0x70));
	...
	lv_obj_set_style_local_text_color(
		ui->module_test_small_output_odds_label, LV_LABEL_PART_MAIN, LV_STATE_DEFAULT, lv_color_make(0xff, 0xc3, 0x70));
	...
	lv_style_set_bg_color(
		&style_module_test_small_output_evens_main, LV_STATE_DEFAULT, lv_color_make(0xff, 0xff, 0xff));
	lv_style_set_bg_grad_color(
		&style_module_test_small_output_evens_main, LV_STATE_DEFAULT, lv_color_make(0xff, 0xff, 0xff));
	...
	lv_style_set_border_color(
		&style_module_test_small_output_evens_main, LV_STATE_DEFAULT, lv_color_make(0xff, 0xc3, 0x70));
	...
	lv_obj_set_style_local_text_color(ui->module_test_small_output_evens_label,
									  LV_LABEL_PART_MAIN,
									  LV_STATE_DEFAULT,
									  lv_color_make(0xff, 0xc3, 0x70));
	...
	lv_style_set_bg_grad_color(
		&style_module_test_small_scale_cv_main, LV_STATE_DEFAULT, lv_color_make(0xff, 0xff, 0xff));
	...
	lv_style_set_border_color(
		&style_module_test_small_scale_cv_main, LV_STATE_DEFAULT, lv_color_make(0xff, 0xc3, 0x70));
	...
	lv_obj_set_style_local_text_color(
		ui->module_test_small_scale_cv_label, LV_LABEL_PART_MAIN, LV_STATE_DEFAULT, lv_color_make(0xff, 0xc3, 0x70));
	...
	lv_style_set_bg_grad_color(
		&style_module_test_small_res_q_cv_main, LV_STATE_DEFAULT, lv_color_make(0xff, 0xff, 0xff));
	...
	lv_style_set_border_color(
		&style_module_test_small_res_q_cv_main, LV_STATE_DEFAULT, lv_color_make(0xff, 0xc3, 0x70));
	...
	lv_obj_set_style_local_text_color(
		ui->module_test_small_res_q_cv_label, LV_LABEL_PART_MAIN, LV_STATE_DEFAULT, lv_color_make(0xff, 0xc3, 0x70));
	...
	lv_style_set_bg_color(
		&style_module_test_small_rotate_scale_main, LV_STATE_DEFAULT, lv_color_make(0xff, 0xff, 0xff));
	lv_style_set_bg_grad_color(
		&style_module_test_small_rotate_scale_main, LV_STATE_DEFAULT, lv_color_make(0xff, 0xff, 0xff));
	...
	lv_style_set_border_color(
		&style_module_test_small_rotate_scale_main, LV_STATE_DEFAULT, lv_color_make(0xff, 0xc3, 0x70));
	...
	lv_obj_set_style_local_text_color(ui->module_test_small_rotate_scale_label,
									  LV_LABEL_PART_MAIN,
									  LV_STATE_DEFAULT,
									  lv_color_make(0xff, 0xc3, 0x70));
	...
	lv_style_set_bg_grad_color(
		&style_module_test_small_morph_cv_main, LV_STATE_DEFAULT, lv_color_make(0xff, 0xff, 0xff));
	...
	lv_style_set_border_color(
		&style_module_test_small_morph_cv_main, LV_STATE_DEFAULT, lv_color_make(0xff, 0xc3, 0x70));
	...
	lv_obj_set_style_local_text_color(
		ui->module_test_small_morph_cv_label, LV_LABEL_PART_MAIN, LV_STATE_DEFAULT, lv_color_make(0xff, 0xc3, 0x70));
	...
	lv_style_set_bg_grad_color(
		&style_module_test_small_spread_cv_main, LV_STATE_DEFAULT, lv_color_make(0xff, 0xff, 0xff));
	...
	lv_style_set_border_color(
		&style_module_test_small_spread_cv_main, LV_STATE_DEFAULT, lv_color_make(0xff, 0xc3, 0x70));
	...
	lv_obj_set_style_local_text_color(
		ui->module_test_small_spread_cv_label, LV_LABEL_PART_MAIN, LV_STATE_DEFAULT, lv_color_make(0xff, 0xc3, 0x70));
	...
	lv_style_set_bg_color(
		&style_module_test_small_scale_r_switch_main, LV_STATE_DEFAULT, lv_color_make(0xff, 0xff, 0xff));
	lv_style_set_bg_grad_color(
		&style_module_test_small_scale_r_switch_main, LV_STATE_DEFAULT, lv_color_make(0xff, 0xff, 0xff));
	...
	lv_style_set_border_color(
		&style_module_test_small_scale_r_switch_main, LV_STATE_DEFAULT, lv_color_make(0xff, 0xc3, 0x70));
	...
	lv_obj_add_style(
		ui->module_test_small_scale_r_switch, LV_BTN_PART_MAIN, &style_module_test_small_scale_r_switch_main);
	...
	lv_obj_set_style_local_text_color(ui->module_test_small_scale_r_switch_label,
									  LV_LABEL_PART_MAIN,
									  LV_STATE_DEFAULT,
									  lv_color_make(0xff, 0xc3, 0x70));
	...
	lv_obj_set_style_local_text_color(
		ui->module_test_small_res_q_label, LV_LABEL_PART_MAIN, LV_STATE_DEFAULT, lv_color_make(0xff, 0xc3, 0x70));
	...
	lv_obj_set_style_local_text_color(
		ui->module_test_small_morph_label, LV_LABEL_PART_MAIN, LV_STATE_DEFAULT, lv_color_make(0xff, 0xc3, 0x70));
	...
	lv_obj_set_style_local_text_color(
		ui->module_test_small_spread_label, LV_LABEL_PART_MAIN, LV_STATE_DEFAULT, lv_color_make(0xff, 0xc3, 0x70));

	//Write codes module_test_small_roller_2
	ui->module_test_small_roller_2 = lv_roller_create(ui->module_test_small, NULL);

	//Write style LV_ROLLER_PART_BG for module_test_small_roller_2
	static lv_style_t style_module_test_small_roller_2_bg;
	lv_style_reset(&style_module_test_small_roller_2_bg);

	//Write style state: LV_STATE_DEFAULT for style_module_test_small_roller_2_bg
	lv_style_set_radius(&style_module_test_small_roller_2_bg, LV_STATE_DEFAULT, 5);
	lv_style_set_bg_color(&style_module_test_small_roller_2_bg, LV_STATE_DEFAULT, lv_color_make(0x00, 0x00, 0x00));
	lv_style_set_bg_grad_color(&style_module_test_small_roller_2_bg, LV_STATE_DEFAULT, lv_color_make(0x00, 0x00, 0x00));
	lv_style_set_bg_grad_dir(&style_module_test_small_roller_2_bg, LV_STATE_DEFAULT, LV_GRAD_DIR_VER);
	lv_style_set_bg_opa(&style_module_test_small_roller_2_bg, LV_STATE_DEFAULT, 255);
	lv_style_set_border_color(&style_module_test_small_roller_2_bg, LV_STATE_DEFAULT, lv_color_make(0xdf, 0xe7, 0xed));
	lv_style_set_border_width(&style_module_test_small_roller_2_bg, LV_STATE_DEFAULT, 0);
	lv_style_set_text_color(&style_module_test_small_roller_2_bg, LV_STATE_DEFAULT, lv_color_make(0xff, 0xff, 0xff));
	lv_obj_add_style(ui->module_test_small_roller_2, LV_ROLLER_PART_BG, &style_module_test_small_roller_2_bg);
	...
	lv_style_set_bg_color(
		&style_module_test_small_roller_2_selected, LV_STATE_DEFAULT, lv_color_make(0xff, 0xc3, 0x70));
	lv_style_set_bg_grad_color(
		&style_module_test_small_roller_2_selected, LV_STATE_DEFAULT, lv_color_make(0xff, 0xc3, 0x70));
	lv_style_set_bg_grad_dir(&style_module_test_small_roller_2_selected, LV_STATE_DEFAULT, LV_GRAD_DIR_VER);
	lv_style_set_bg_opa(&style_module_test_small_roller_2_selected, LV_STATE_DEFAULT, 255);
	lv_style_set_text_color(
		&style_module_test_small_roller_2_selected, LV_STATE_DEFAULT, lv_color_make(0x00, 0x00, 0x00));
	lv_obj_add_style(
		ui->module_test_small_roller_2, LV_ROLLER_PART_SELECTED, &style_module_test_small_roller_2_selected);
	lv_obj_set_pos(ui->module_test_small_roller_2, 248, 1);
	...
	lv_obj_set_style_local_text_font(
		ui->module_test_small_roller_2, LV_ROLLER_PART_BG, LV_STATE_DEFAULT, &lv_font_MuseoSansRounded_500_12);
	lv_obj_set_style_local_text_font(
		ui->module_test_small_roller_2, LV_ROLLER_PART_BG, LV_STATE_FOCUSED, &lv_font_MuseoSansRounded_700_12);
	lv_obj_set_style_local_text_font(
		ui->module_test_small_roller_2, LV_ROLLER_PART_SELECTED, LV_STATE_DEFAULT, &lv_font_MuseoSansRounded_500_12);
