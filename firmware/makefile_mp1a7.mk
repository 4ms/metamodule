...
USBD_LIBDIR 		= $(LIBDIR)/stm32-usb-device-lib
USBH_LIBDIR 		= $(LIBDIR)/stm32-usb-host-lib
...
SOURCES += $(USBD_LIBDIR)/Class/MSC/Src/usbd_msc.c
SOURCES += $(USBD_LIBDIR)/Class/MSC/Src/usbd_msc_bot.c
SOURCES += $(USBD_LIBDIR)/Class/MSC/Src/usbd_msc_data.c
SOURCES += $(USBD_LIBDIR)/Class/MSC/Src/usbd_msc_scsi.c
SOURCES += $(USBD_LIBDIR)/Core/Src/usbd_core.c
SOURCES += $(USBD_LIBDIR)/Core/Src/usbd_ctlreq.c
SOURCES += $(USBD_LIBDIR)/Core/Src/usbd_ioreq.c
...
SOURCES += $(USBH_LIBDIR)/Core/Src/usbh_pipes.c
...
INCLUDES +=		-I$(USBD_LIBDIR)/Class/MSC/Inc
INCLUDES +=		-I$(USBD_LIBDIR)/Core/Inc
INCLUDES +=		-I$(USBD_LIBDIR)/Class/HUB/Inc
INCLUDES +=		-I$(USBH_LIBDIR)/Core/Inc
